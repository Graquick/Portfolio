...
export const MenuItem = ({ i }) => {
  ...
  const links = [
    ...
    },
    {
      id: 5,
      title: "linkedin",
      href: "https://linkedin.com/in/brima-freeman-34aa05238",
  ...
  return (
    <motion.div
      className="absolute top-[100px] left-0 w-[300px] h-[350px] pl-[50px] hidden invisible flex-col z-10"
      ...
      {links.map((links) => (
        ...
        >
          <div className="w-[175px] h-[50px] uppercase text-[1.75rem] my-2 mx-0 flex text-black dark:text-white">
            ...
            <Icon
              icon={links.icon}
              className="ml-[10px] text-[28px] relative top-1"
            />
          </div>
        </motion.li>
      ))}
