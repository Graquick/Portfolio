    ...
    <AnimatePresence exitBeforeEnter>
      {showJModal && (
        <motion.div
          ...
          exit="hidden"
        >
          <motion.div variants={modal} className={styles.blogModalCont}>
            ...
            <motion.div variants={modal} className={styles.blogModalTwo}>
              <div>
                <h1>
                  <div className={styles.bfBlogLogo}>bf</div>
                  <div className={styles.bfBlogLogo2}>blog</div>
                </h1>
                <p className="text-[1.3rem] font-medium text-black">
                  My own Blog site! There, you&apos;ll find different types of
                  posts from both my personal and work life.
                </p>
                <br />
                <p className="text-[1.3rem] font-medium text-black">
