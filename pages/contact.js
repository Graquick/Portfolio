...
const Contact = () => {
  ...
  const cardIconsParent = [
    ...
    { id: 2, title: "Phone:", pholder: "+358 469686908", icon: "bxs:phone" },
    {
      id: 3,
      title: "Email:",
      pholder: "bimu.freeman@outlook.com",
      icon: "ic:round-email",
    },
  ];
  ...
  return (
    <div className="px-5 transition duration-500 bg-gray-200 pt-36 dark:bg-neutral-800 lg:px-0 lg:pt-[6rem]">
      ...
      <motion.main
        ...
        // className={styles.main}
      >
        <h1 className="m-0 leading-tight text-[4rem] text-center">Contact</h1>

        <p className="mx-0 mt-4 mb-8 leading-normal text-center cursor-default text-[1.5rem] xl:text-[1.3rem] lg:w-[350px]">
          Start by filling in the form, and I will get back to you as soon as
          possible.
        </p>

        <motion.div className={styles.grid} variants={gridVariants}>
          <div className="flex flex-col justify-around px-12 py-4 text-left no-underline shadow-md bg-white/80 backdrop-blur-sm dark:bg-neutral-700 2xl:px-4 2xl:items-center xl:p-12 lg:p-4">
            <h1 className="text-[2.5rem] 2xl:w-[85%] lg:text-[1.25rem]">
              Let&apos;s get in touch
            </h1>
            <p className="font-medium text-[1.125rem] 2xl:w-[85%] xl:text-[1.5rem] lg:text-[1rem]">
              I&apos;m looking forward to working on a new project with you.
            </p>

            <div
              className="h-[65%] p-0 flex flex-col 2xl:w-[85%] lg:w-[90%]"
              // className={styles.cardIconCont}
            >
              {cardIconsParent.map((cards, i) => (
                <div className={styles.cardIconsParent} key={cards.id}>
                  <div
                    className="w-[50px] h-[50px] rounded-full mr-8 bg-black flex justify-center items-center text-[1.5rem] dark:bg-white lg:w-[30px] lg:h-[30px] lg:text-[.75rem]"
                    // className={styles.cardIcon}
                  >
                    <Icon
                      className="text-white transition-all duration-150 ease-in-out dark:text-black"
                  ...
                  <div className={styles.cardIconText}>
                    ...
                    <p className="text-[1.5rem] font-light font-roboto 2xl:text-[1.25rem] xl:text-[1.5rem] lg:text-[1.125rem]">
                      {cards.pholder}
                    </p>
                  </div>
                </div>
          ...
          <form
            className="px-8 pt-8 text-left no-underline shadow-md text-inherit bg-white/80 backdrop-blur-sm dark:bg-neutral-700 2xl:pt-4 2xl:px-4 lg:p-0 "
          ...
          >
            ...
            <div className={styles.formContent}>
              ...
              <div className="flex flex-col items-center justify-center h-[375px]  lg:h-fit">
                <div className="w-full flex flex-col relative lg:w-[95%]">
                  <label
                    htmlFor="subject"
                    className="font-[600] uppercase text-[.75rem] mb-2"
                  >
                    subject
                  </label>
                  <input
                ...
                <div className="flex flex-col h-[90%] w-full relative lg:w-[95%]">
                  <label
                    htmlFor="message"
                    className="font-[600] uppercase text-[.75rem] mt-4 mb-2"
                  >
                    message
                  </label>
                  <textarea
                    ...
                    cols="1"
                    required
                    className="p-2 text-[1.25rem] leading-[1.5] shadow h-full  dark:text-black"
            ...
            <motion.div
              className="bg-neutral-800 text-white ml-3 cursor-pointer w-[13rem] h-[3rem] text-[1.25rem] p-3 relative flex items-center justify-center  2xl:p-0 2xl:text-[1.3rem] 2xl:after:-bottom-2 xl:text-[1.2rem] xl:after:h-[1.5px] lg:text-[1rem] lg:h-[2rem] lg:w-[10rem] dark:bg-neutral-200 dark:text-black"
            ...
            >
              <input
                type="submit"
                value="send message"
                className="uppercase cursor-pointer font-[400]"
              />
            </motion.div>
          </form>
        </motion.div>
