        ...
        <div className="px-5 transition duration-500 bg-gray-200 pt-36 dark:bg-neutral-800 lg:px-0 lg:pt-[6rem]">
            ...
            >
                ...
                <motion.div className={styles.grid} variants={gridVariants}>
                    ...
                    <form className="px-8 pt-8 text-left no-underline shadow-md text-inherit bg-white/80 backdrop-blur-sm dark:bg-neutral-700 2xl:pt-4 2xl:px-4 lg:p-0 "
                    ...
                    >
                        ...
                        <motion.div className="bg-neutral-800 text-white ml-3 cursor-pointer w-[13rem] h-[3rem] text-[1.25rem] p-3 relative flex items-center justify-center  2xl:p-0 2xl:text-[1.3rem] 2xl:after:-bottom-2 xl:text-[1.2rem] xl:after:h-[1.5px] lg:text-[1rem] lg:h-[2rem] lg:w-[10rem] dark:bg-neutral-200 dark:text-black"
                          whileHover={{ x: 10, transition: { duration: .1 }}}
                          whileTap={{ scale: 0.5 }}
                        >
                            <input type="submit" value="send message" className="uppercase cursor-pointer font-[400]"/>
                        </motion.div>
