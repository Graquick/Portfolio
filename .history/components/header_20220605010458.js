...
export default function Header() {
    ...
    >
        ...
        <div className="w-96 font-medium uppercase flex flex-col justify-center text-lg bg-emerald-300 xl:w-64">
            <ul className="flex align-center justify-around h-12 bg-red-400"
