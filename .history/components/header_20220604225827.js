...
export default function Header() {
    ...
    >
        <motion.div className="uppercase border-transparent text-3xl text-center font-medium cursor-pointer h-14 w-56 bg-slate-500 self-center flex align-center justify-center"
            exit={{ y: -100}}
            initial={{ y: -100 }}
        ...
        >
            <Link href="/">
                ...
                >
                    graquick
                    <svg className="realative top-4 left-6"
                        width={16}
                        height={28}
                        viewBox="0 0 11 22"
                        fill="none"
