...
export default function Header(props) {
    ...
    const renderThemeChanger = () => {
        ...
        if (currentTheme === "dark") {
            return (
                <div className="w-[50px] h-[50px] rounded-full flex justify-center items-center text-2xl bg-gray-200 cursor-pointer transition-all duration-300 ease hover:rotate-[360deg] active:scale-50 xl:mr-[1.5rem] lg:transform lg:scale-75 dark:bg-neutral-800 dark:text-white"
    ...
    className="shadow-sm backdrop-blur-lg sticky transition duration-500 top-0 z-10 flex justify-between w-[90%] h-24 px-8 py-4 m-auto max-w-[1400px] bg-white/90 dark:bg-black/80 lg:w-full lg:h-20"
