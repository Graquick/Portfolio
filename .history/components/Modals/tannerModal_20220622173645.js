                ...
                >
                    ...
                    >
                            ...
                            <div className="flex items-center justify-center overflow-hidden relative" >
                                <AnimatePresence>
                                    <motion.div className={`w-[800px] h-[400px] ${colors[Math.abs(count) % 4]} flex items-center text-[10rem] font-bold font-roboto absolute justify-center text-white cursor-default`}
                                        key={count}
                                        exit={{ x: -500 }}
                                        initial={{ x: 500 }}
