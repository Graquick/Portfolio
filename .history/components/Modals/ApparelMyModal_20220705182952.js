...
const ApparelMyModal = ( {showApparelMyModal, setShowApparelMyModal} ) => {
    ...
    let images = ["bg-[url('/apparel-big-1-hero.PNG')]", "bg-[url('/apparel-big-2-hero.PNG')]", "bg-[url('/apparel-big-3-hero.PNG')]"]
        ...
        <AnimatePresence exitBeforeEnter>
            { showApparelMyModal && (
                ...
                >
                    <motion.div
                        variants={modal}
                        className="m-auto absolute top-0 left-0 bottom-0 right-0 w-[1300px] h-[450px] flex flex-col justify-center align-center bg-neutral-700 2xl:w-[1000px] 2xl:h-[550px] xl:w-[750px] lg:w-[355px] lg:h-[450px]"
                    >
                            ...
                            >
                                ...
                                <motion.div className={styles.closeBtn} onClick={() => {setShowApparelMyModal(false)}}
                            ...
                            <div className="w-[25%] flex items-center justify-between">
                                ...
                                text-white hover:text-black hover:bg-white xl:left-0 z-10 xl:text-black/50 xl:hover:text-black xl:hover:bg-transparent" onClick={() => setCount(count - 1)
                                }
                                >
                                ...
                                text-white hover:text-black hover:bg-white xl:right-0 z-10 xl:text-black/50 xl:hover:text-black xl:hover:bg-transparent" onClick={() => setCount(count + 1)
                               }>
                            ...
                            <div ref={ref}  className="self-center flex items-center justify-center overflow-hidden bg-black/50 h-full w-full relative" >
                                <AnimatePresence custom={{direction, width}}>
                                    <motion.div className={`w-[1400px] h-[900px] 2xl:w-[1000px] 2xl:h-[550px] xl:w-[750px] lg:w-[355px] lg:h-[450px] ${images[Math.abs(count) % 4]} bg-contain bg-no-repeat bg-center absolute justify-center text-white cursor-default`}
                                        key={count}
                                        variants={variants}
                                        initial="enter"
                                        animate="center"
