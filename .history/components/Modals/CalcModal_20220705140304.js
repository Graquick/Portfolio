            ...
            { showRModal && (
                ...
                >
                    ...
                    >
                        <div>
                            <h1>Calco, Inc.</h1>
                            <p className="text-[1.3rem] font-medium text-black xl:text-[1.1rem]">Here&apos;s my cool calculator app with different colour themes. I had so much fun creating this one.</p>
                            <br />
