...
const CalcModal = ( {showRModal, setShowRModal} ) => {
    ...
    return (
        <AnimatePresence exitBeforeEnter>
            { showRModal && (
                <motion.div className="backdrop" onClick={() => { setShowRModal(false) }}
                    variants={backDrop}
                    initial="hidden"
                    animate="visible"
                    exit="hidden"
                >
                    ...
                    >
                        <div>
                            <h1>Calco, Inc.</h1>
                            <p>Here&apos;s my cool calculator app with different colour themes. I had so much fun creating this one.</p>
                            <br />
