                ...
                >
                    ...
                    >
                        <div>
                            ...
                            <p className="text-[1.3rem] font-medium dark:text-black">An intro section with a dropdown navigation. Includes dropdown navigation menus.</p>
                            <br />
                            <p className="text-[1.3rem] font-medium">Check out the full description at my projects page.</p>
