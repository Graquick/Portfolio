            ...
            { showJModal && (
                ...
                >
                    ...
                    >
                            ...
                            >
                                <div>
                                <div className={styles.bfBlogLogo}>bf</div><div className={styles.bfBlogLogo2}>blog</div></div>
                                    <p>My own Blog site! There, you&apos;ll find different types of posts from both my personal and work life.</p>
                                    <br />
