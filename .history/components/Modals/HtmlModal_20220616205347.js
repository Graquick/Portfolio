                ...
                >
                    ...
                    >
                        <div>
                            ...
                            <br />
                            <p>Check the out the full description at my projects page.</p>
                            <motion.div className={styles.closeBar}
                            >
                                <Icon icon="fa-regular:window-minimize" style={{ color: "#a8a8a8" }}/>
                                <Icon icon="clarity:window-max-line" style={{ color: "#a8a8a8" }}/>
