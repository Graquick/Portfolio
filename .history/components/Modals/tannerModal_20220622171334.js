                ...
                >
                    ...
                    >
                            ...
                            <div className="w-[25%] flex items-center justify-between">
                                <div className=" rounded-lg w-fit flex justify-center items-center font-bold text-[3rem] transition-all duration-150 ease-in-out active:transform active:scale-50 cursor-pointer hover:text-white hover:bg-blue-900" onClick={() => setCount(count-1)}>
