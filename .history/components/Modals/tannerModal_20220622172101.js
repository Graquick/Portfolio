        ...
        <AnimatePresence exitBeforeEnter>
            { showTannerModal && (
                ...
                >
                    <motion.div
                        variants={modal}
                        className="m-auto absolute top-0 left-0 bottom-0 right-0 w-[1400px] h-[800px] flex flex-col justify-around bg-slate-400"
                    >
                            ...
                            <div className="bg-green-400 text-xl font-bold flex items-center justify-center" >
                                <div>
                                    <div>
                                        {count}
                                    </div>
