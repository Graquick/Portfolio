                    ...
                    >
                            ...
                            <div ref={ref}  className="self-center flex items-center justify-center overflow-hidden bg-black/50 h-full w-full relative" >
                                <AnimatePresence custom={{direction, width}}>
                                    <motion.div className={`w-[1400px] h-[900px] ${images[Math.abs(count) % 4]} absolute bg-cover justify-center text-white cursor-default 2xl:w-[1000px] xl:w-[750px] lg:w-[355px] 2xl:${images2xl[Math.abs(count) % 4]`}
                                        key={count}
                                        variants={variants}
                                        initial="enter"
                                        animate="center"
