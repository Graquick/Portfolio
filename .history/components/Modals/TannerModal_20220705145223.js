                ...
                >
                    ...
                    >
                            ...
                            <div className="w-[25%] flex items-center justify-between">
                                ...
                                text-white hover:text-black hover:bg-white lg:left-0" onClick={() => setCount(count - 1)
                                }
                                >
                                ...
                                text-white hover:text-black hover:bg-white lg:right-0" onClick={() => setCount(count + 1)
                               }>
