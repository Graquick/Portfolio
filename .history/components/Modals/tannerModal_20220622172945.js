                ...
                >
                    ...
                    >
                            ...
                            <div className="flex items-center justify-center" >
                                    <div className="w-[800px] h-[400px] bg-fuchsia-200 flex items-center text-[10rem] font-bold font-roboto justify-center cursor-default">
                                        {count}
                                    </div>
                            </div>
...
let colors = ["bg-red-500", "bg-blue-500", "bg-green-500", "bg-red-500"]
