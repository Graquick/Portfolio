        ...
        <AnimatePresence exitBeforeEnter>
            { showModal && (
                ...
                >
                    <motion.div
                        variants={modal}
                        className="absolute top-0 bottom-0 left-0 right-0 m-auto w-[800px] h-[400px] bg-[url('/snap-hero.PNG')] bg-cover shadow-md grid grid-cols-[50%] grid-rows-[100%] p-8 text-left"
