                    ...
                    >
                            ...
                            <div ref={ref}  className="self-center flex items-center justify-center overflow-hidden bg-black/50 h-[400px] w-[800px] relative" >
                                <AnimatePresence custom={{direction, width}}>
                                    <motion.div className={`w-20 h-[400px] ${colors[Math.abs(count) % 4]} flex items-center text-[1rem] font-bold font-roboto absolute justify-center text-white cursor-default`}
                                        key={count}
                                        variants={variants}
                                        initial="enter"
                                        animate="center"
