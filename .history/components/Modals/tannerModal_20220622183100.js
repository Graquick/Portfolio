            ...
            { showTannerModal && (
                ...
                >
                    ...
                    >
                            ...
                            <div className="self-center flex items-center mt-8 justify-center overflow-hidden bg-black/25 h-12 w-80 relative">
                                <div className={`w-8 h-8 bg-white/50 ${colors[Math.abs(count) % 4]}`}>
