        ...
        <AnimatePresence exitBeforeEnter>
            { showSteppModal && (
                ...
                >
                    <motion.div
                        variants={modal}
                        className="m-auto absolute top-0 left-0 bottom-0 right-0 w-[1300px] h-[450px] flex flex-col justify-center align-center bg-red-300 backdrop-blur-0 2xl:w-[1000px] 2xl:h-[550px] xl:w-[750px] xl:h-[450px] lg:w-[355px] lg:h-[206px]"
                    >
