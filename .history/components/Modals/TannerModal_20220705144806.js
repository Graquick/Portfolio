        ...
        <AnimatePresence exitBeforeEnter>
            { showTannerModal && (
                ...
                >
                    <motion.div
                        variants={modal}
                        className="m-auto absolute top-0 left-0 bottom-0 right-0 w-[1500px] h-[900px] flex flex-col justify-center align-center bg-white opacity-[85%] 2xl:w-[1000px] xl:w-[750px] lg:w-[355px]"
                    >
                            ...
                            <div ref={ref}  className="self-center flex items-center justify-center overflow-hidden bg-black/50 h-full w-full relative" >
                                <AnimatePresence custom={{direction, width}}>
                                    <motion.div className={`w-[1400px] h-[900px] ${images[Math.abs(count) % 4]} absolute bg-cover justify-center text-white cursor-default 2xl:w-[900px] xl:w-[650px] lg:w-[255px]`}
                                        key={count}
                                        variants={variants}
                                        initial="enter"
                                        animate="center"
