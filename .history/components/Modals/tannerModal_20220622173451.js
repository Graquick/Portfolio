                ...
                >
                    ...
                    >
                            ...
                            <div className="flex items-center justify-center over" >
                                <AnimatePresence>
                                    <motion.div className={`w-[800px] h-[400px] ${colors[Math.abs(count) % 4]} flex items-center text-[10rem] font-bold font-roboto justify-center text-white cursor-default`}
                                        key={count}
                                        initial={{ x: 500 }}
                                        animate={{ x: 0 }}
                                    >
