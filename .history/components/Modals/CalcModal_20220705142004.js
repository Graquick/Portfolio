        ...
        <AnimatePresence exitBeforeEnter>
            { showRModal && (
                ...
                >
                    ...
                    >
                        <div>
                            <h1 className="font-play text-[2.3rem] text-white capitalize mb-12 xl:mb-2 xl:text-[2rem] dark:text-black">Calco, Inc.</h1>
                            <p className="text-[1.3rem] font-medium text-white xl:text-[1.1rem] dark:text-black">Here&apos;s my cool calculator app with different colour themes. I had so much fun creating this one.</p>
                            <br />
