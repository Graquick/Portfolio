                ...
                >
                    ...
                    >
                            ...
                            <div className="w-[25%] flex items-center justify-between">
                                <div className="p-8 bg-white rounded-lg w-fit h-10 flex justify-center items-center font-bold text-lg transition-all duration-150 ease-in-out active:transform active:scale-50 cursor-pointer hover:text-white hover:bg-blue-900" onc>
                                    Previous
                                </div>
