                ...
                >
                    ...
                    >
                            ...
                            <div className="flex items-center justify-center overflow-hidden bg-black/50 h-24 w-24 relative" >
                                <AnimatePresence>
                                    <motion.div className={`w-20 h-20 ${colors[Math.abs(count) % 4]} flex items-center text-[1rem] font-bold font-roboto relative justify-center text-white cursor-default`}
                                        key={count}
                                        exit={{ x: -100 }}
                                        initial={{ x: 100 }}
                                        animate={{ x: 0 }}
