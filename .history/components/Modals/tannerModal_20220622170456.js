            ...
            { showTannerModal && (
                ...
                >
                    ...
                    >
                            ...
                            <div className="p-8 bg-white rounded-lg w-fit h-10 flex justify-center items-center font-bold text-lg transition-all duration-150 ease-in-out active:transform active:scale-50">
                                Previous
                            </div>
                            <div>
                                Next
