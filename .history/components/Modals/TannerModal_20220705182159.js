...
const TannerModal = ( {showTannerModal, setShowTannerModal} ) => {
    ...
    let images2xl = ["bg-[url('/tanner-big-1-hero-2xl.png')]", "bg-[url('/tanner-big-2-hero.PNG')]", "bg-[url('/tanner-big-3-hero.PNG')]", "bg-[url('/tanner-big-4-hero.PNG')]"]
        ...
        <AnimatePresence exitBeforeEnter>
            { showTannerModal && (
                ...
                >
                    <motion.div
                        variants={modal}
                        className="m-auto absolute top-0 left-0 bottom-0 right-0 w-[1400px] h-[900px] flex flex-col justify-center align-center bg-[#dedede] 2xl:w-[1000px] 2xl:h-[550px] xl:w-[750px] lg:w-[355px] lg:h-[450px]"
                    >
                            ...
                            <div ref={ref}  className="self-center flex items-center justify-center overflow-hidden bg-black/50 h-full w-full relative" >
                                <AnimatePresence custom={{direction, width}}>
                                    <motion.div className={`w-[1400px] h-[900px] absolute justify-center text-white cursor-default 2xl:w-[1000px] xl:w-[750px] lg:w-[355px] ${images[Math.abs(count) % 4]} 2xl:${images2xl[Math.abs(count) % 4]} bg-contain bg-no-repeat bg-center`}
                                        key={count}
                                        variants={variants}
                                        initial="enter"
                                        animate="center"
