            ...
            { showRModal && (
                ...
                >
                    ...
                    >
                        <div>
                            <h1>Calco, Inc.</h1>
                            <p className="xl:text-[1.1rem]">Here&apos;s my cool calculator app with different colour themes. I had so much fun creating this one.</p>
                            <br />
                            <p className="xl:text-[1.1rem]">Check out the full description at my projects page.</p>
