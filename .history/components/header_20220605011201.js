...
export default function Header() {
    ...
    >
        <motion.div className="uppercase border-transparent text-3xl font-refular cursor-pointer h-14 w-56 self-center flex flex-col justify-center"
            exit={{ y: -100}}
            initial={{ y: -100 }}
        ...
        <div className="w-96 font-medium uppercase flex flex-col justify-center text-lg lg:w-64">
