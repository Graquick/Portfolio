...
export default function Header(props) {
    ...
    >
        ...
        <div className={styles.right} onClick={() => setTheme(colorTheme)}>
            {colorTheme === "light" ?
            (
                <div   className="w-[50px] h-[50px] rounded-full flex justify-center items-center text-2xl bg-gray-200 cursor-pointer transition-all duration-200 ease hover:rotate-[360deg] active:scale-50 xl:"
