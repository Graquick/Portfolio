...
export default function Header() {
    ...
    <header className="max-w-7xl mx-auto px-4 flex justify-between border-b-2 border-gray-100 py-6"
    // className={styles.header}
    >
        <motion.div className="uppercase border-transparent text-3xl font-medium cursor-pointer h-15 w-15 bg-slate-500"
            exit={{ y: -100}}
            initial={{ y: -100 }}
        ...
        <div className="bg-orange-400 flex w-50">
            <ul
