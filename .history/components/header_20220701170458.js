...
export default function Header(props) {
    ...
    const renderThemeChanger = () => {
        ...
        if (currentTheme === "dark") {
            return (
                <div className="w-[50px] h-[50px] rounded-full flex justify-center items-center text-2xl bg-gray-200 cursor-pointer transition-all duration-300 ease hover:rotate-[360deg] active:scale-50 xl:mr-16 lg:transform lg:scale-75 dark:bg-neutral-800 dark:text-white"
