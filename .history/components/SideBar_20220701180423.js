  ...
  return mounted && (
    <>  
        ...
        <AnimatePresence>
            ...
            <motion.div className="bg-neutral-100/80 backdrop-blur-lg h-[150px] w-[90%] absolute top-12 left-0 right-0 m-auto z-10 flex flex-col justify-center items-center text-black dark:bg-neutral-800/80 dark:text-white xl:block"
                initial={false}
