...
export default function Header() {
    ...
    <header className="sticky top-0 z-10 flex justify-between bg-white border-b border-gray-200 h-100px align-center"
    ...
    >
        ...
        >
            <Link href="/">
                <div className="flex text-3xl font-normal uppercase bg-red-500 border border-transparent rounded-lg cursor-pointer h-50px w-200px align-center justif"
