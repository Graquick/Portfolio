...
export default function Header(props) {
    ...
    <header className="sticky top-0 z-10 flex justify-between h-24 mx-auto bg-gray-100 max-w-7xl"
    ...
    >
        ...
        <div className="flex flex-col justify-center w-2/5 uppercase text-md xl:w-48">
            <ul className="links"
