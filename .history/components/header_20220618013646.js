...
export default function Header(props) {
    ...
    <header className="backdrop-blur sticky transition duration-500 delay-300 top-0 z-10 flex justify-between w-[90%] h-24 px-8 py-4 m-auto max-w-[1400px] bg-neutral-50 opacity-80 dark:bg-neutral-900"
