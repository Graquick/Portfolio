...
export default function Header() {
    ...
    <header className="sticky bg-red-500 top-0 max-w-7xl flex mx-auto"
    // className={styles.header}
    >
        <motion.div className="uppercase border-transparent text-3xl font-medium cursor-pointer h-full w-15 bg-slate-500"
            exit={{ y: -100}}
            initial={{ y: -100 }}
