                ...
                {links.map((links, i) => (
                    <div key={links}>
                                <motion.div
                                    ...
                                    className={router.pathname === links.href ? "font-medium p-2 relative after:content[''] after:absolute transition-all duration-300 ease-in-out after:bottom-0 after:left-0 after:bg-black after:w-2/5 after:h-[3px] after:transition-all after:duration-150 after:ease-in-out hover:after:w-full" : "font-medium p-2 relative after:content[''] after:absolute after:bottom-0 after:left-0 after:bg-black after:w-[0%] after:h-[3px] after:transition after:duration-300 after:ease-in-out hover:after:w-full"}
