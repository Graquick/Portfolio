...
export default function Header() {
    ...
    >
        ...
        <div className="bg-orange-400 w-96 font-medium uppercase flex flex-col justify-center text-md">
            <ul className="flex align-center justify-around bg-emerald-600 h-14"
            ...
            >
                ...
                <div className="text-white bg-black h-14 w-14 rounded-full text-2xl flex flex-col align-center justify-center"
