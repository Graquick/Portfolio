  ...
  return (
    <>
        <AnimatePresence>
            ...
            >
                <div>
                    <ul className="absolute left-0 top-24 bg-orange-400 flex flex-col items-center justify-around h-[400px] text-xl uppercase transition duration-500 dark:text-white"
