...
function Footer() {
  ...
  return (
    <div>
      ...
      className="max-w-[1400px] w-[90%] m-auto bg-white/90 backdrop-blur-sm shadow-sm flex py-6 px-0 justify-center items-center text-md uppercase dark:bg-black/80 dark:text-gray-300 lg:text-[0.5rem] "
       // className="footer"
      >
