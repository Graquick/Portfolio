...
export default function Header() {
    ...
    <header className="sticky bg-slate-200 top-0 max-w-7xl flex mx-auto justify-between z-10 h-24"
    // className={styles.header}
    >
        <motion.div className="uppercase border-transparent text-3xl font-bold cursor-pointer h-14 w-56 self-center flex flex-col justify-center"
            exit={{ y: -100}}
            initial={{ y: -100 }}
