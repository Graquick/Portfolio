                ...
                {links.map((links, i) => (
                    <div key={links}>
                                <motion.div
                                    ...
                                    className={router.pathname === links.href ? "font-medium p-2 relative after:content[''] after:absolute after:bottom-0 after:left-0 after:bg-black after:w-2/5" : "darkOtherPage"}
