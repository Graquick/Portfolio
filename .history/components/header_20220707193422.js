...
export default function Header(props) {
    ...
    const renderThemeChanger = () => {
        ...
        if (currentTheme === "dark") {
            return (
                <div className="w-[50px] h-[50px] rounded-full flex justify-center items-center text-2xl bg-gray-200 cursor-pointer transition-all duration-300 ease hover:rotate-[360deg] active:scale-50 xl:mr-[1.25rem] lg:transform lg:scale-75 dark:bg-neutral-800 dark:text-white"
    ...
    >
        <AnimatePresence>
            ...
            >
                <Link href="/" passHref>
                    <div   className="flex items-end justify-end w-16 h-16 px-1 py-0 text-lg font-bold uppercase transition duration-500 bg-gray-200 shadow-sm dark:bg-neutral-800 dark:text-white lg:transform lg:scale-[70%]"
