...
export default function Header(props) {
    ...
    className="shadow-sm backdrop-blur-lg fixed transition duration-500 top-0 left-0 right-0 z-20 flex justify-between w-[90%] h-24 px-8 py-4 m-auto max-w-[1400px] bg-white/90 dark:bg-neutral-800 lg:w-full lg:h-20"
         // className={styles.header}
    >
        <AnimatePresence>
            <motion.div // className="self-center w-56 uppercase border-transparent cursor-pointer h-14"
                className="cursor-pointer lg:transform lg:scale-50 flex items-center justify-center"
