                ...
                {links.map((links, i) => (
                    <div key={links}>
                                <motion.div
                                    ...
                                    className={router.pathname === links.href ? "font-medium p-2 relative after:content[''] after:absolute after:bottom-0 after:left-0 after:bg-black after:w-2/5 after:h-[3px] after:transition after:duration-300 after:ease-in-out " : "darkOtherPage"}
