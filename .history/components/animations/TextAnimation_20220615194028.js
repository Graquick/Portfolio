...
const animation = keyframes`
    0% { opacity: 0; transform: translateY(-350px) skewY(10deg) skewX(10deg) rotateZ(30deg); filter: blur(10px);}
    ...
    100% { opacity: 0; transform: translateY(-350px) skewY(10deg) skewX(10deg) rotateZ(30deg); filter: blur(10px)}
`
