...
export default function Header(props) {
    ...
    >
        <AnimatePresence>
            ...
            >
                <Link href="/">
                    <div   className="flex items-end justify-end w-16 h-16 px-1 py-0 text-lg font-bold uppercase transition duration-500 delay-300 bg-gray-200 shadow-sm dark:bg-black dark:text-white"
