    ...
    >
        <AnimatePresence>
            <motion.div // className="self-center w-56 uppercase border-transparent cursor-pointer h-14"
                className="cursor-pointer lg:transform lg:scale-50"
            ...
            >
                <Link href="/" passHref>
                    <div   className="flex items-end justify-end w-16 h-16 px-1 py-0 text-lg font-bold uppercase transition duration-500 bg-gray-200 shadow-sm dark:bg-neutral-800 dark:text-white lg:transform lg:scale-50"
