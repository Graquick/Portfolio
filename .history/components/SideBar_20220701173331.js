    ...
    <>
        <AnimatePresence>
            ...
            <motion.div className=""
                ...
                exit="closed"
            >
                <div className="absolute left-0 top-28 bg-orange-400 flex flex-col items-center justify-around w-full h-[400px] text-xl uppercase transition duration-500 dark:text-white">
                    <ul 
