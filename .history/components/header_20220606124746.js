...
export default function Header() {
    ...
    <header className="sticky bg-white top-0 max-w-7xl flex mx-auto justify-between z-10 h-24 shadow-sm rounded-xl"
    ...
    >
        ...
        <div className="w-2/5 uppercase flex flex-col justify-center text-lg xl:w-48">
            <ul className="links"
                ...
                {links.map((links, i) => (
                    ...
                    >
                        <Link href={links.href}>
                            <Icon icon={links.icon} className="text-3xl"/>
                        </Link>
