...
function Footer() {
  ...
  return (
    <div>
      ...
      className="max-w-[1400px] w-[90%] m-auto bg-white/90 backdrop-blur-sm shadow-sm flex py-6 px-0 justify-center text-md uppercase fixed left-0 right-0 z-20 bottom-0 dark:bg-black/80 dark:text-gray-300 lg:h-2 lg:p-0 "
       // className="footer"
      >
