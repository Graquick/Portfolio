...
export default function Header() {
    ...
    >
        <motion.div className="uppercase border-transparent text-3xl font-medium cursor-pointer h-14 w-56 bg-slate-500 self-center"
            exit={{ y: -100}}
            initial={{ y: -100 }}
        ...
        >
            <Link href="/">
                <div className="flex justify-around bg-slate-700 align-center"
                // className={styles.logo}
                >
                    graquick
                    <svg className="flex justify-center align-center bg-black"
                        width={16}
                        height={28}
                        viewBox="0 0 11 22"
                        fill="none"
