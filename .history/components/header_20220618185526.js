...
export default function Header(props) {
    ...
    <header className="shadow-sm backdrop-blur-sm sticky transition duration-500 delay-300 top-0 z-10 flex justify-between w-[90%] h-24 px-8 py-4 m-auto max-w-[1400px] bg-white/90  "
