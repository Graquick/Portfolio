...
export default function Header() {
    ...
    >
        ...
        <div className="w-96 font-regular uppercase flex flex-col justify-center text-xl lg:w-64">
            ...
            >
                ...
                <motion.div className="w-12 h-12 bg-black text-lg rounded-full cursor-pointer"
                    whileHover={{ rotate: 360, transition: { duration: .3 } } }
                    whileTap={{ scale: .5, transition: { duration: .1 } }}
                // className={styles.liMoon}
                >
                    <Link href={''}>
                        <Icon className=" text-white" icon='bx-moon' />
                    </Link>
                </motion.div>
            </ul>
