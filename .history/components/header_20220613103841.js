...
export default function Header(props) {
    ...
    <header className="sticky top-0 z-10 flex justify-between w-full h-24 mx-auto bg-gray-500 shadow-sm rounded-b-xl"
    ...
    >
        ...
        <div className="flex flex-col justify-center w-2/6 text-lg uppercase xl:w-48">
            <ul className="links"
