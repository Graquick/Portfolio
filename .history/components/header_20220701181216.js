...
export default function Header(props) {
    ...
    className="shadow-sm backdrop-blur-lg fixed transition duration-500 top-0 z-20 flex justify-between w-[90%] h-24 px-8 py-4 m-auto max-w-[1400px] bg-white/90 dark:bg-black/80 lg:w-full lg:h-20"
