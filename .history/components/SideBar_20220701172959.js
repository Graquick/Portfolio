  ...
  return (
    <>
        <AnimatePresence>
            ...
            >
                <div>
                    <ul className="absolute left-0 bottom-0 bg-brown-400 flex flex-col items-center justify-around h-full text-xl uppercase transition duration-500 dark:text-white"
