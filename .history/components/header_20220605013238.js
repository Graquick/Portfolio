...
export default function Header() {
    ...
    >
        ...
        <div className="w-96 font-regular uppercase flex flex-col justify-center text-lg lg:w-64">
            ...
            >
                ...
                <div className="w-12 h-12 bg-black flex justify-center align-center text-lg rounded-full cursor-pointer"
