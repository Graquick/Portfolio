...
export default function Header(props) {
    ...
    <header className="shadow-sm backdrop-blur-sm sticky transition duration-500 delay-300 top-0 z-10 flex justify-between w-[90%] h-24 px-8 py-4 m-auto max-w-[1400px] bg-white/90 dark:bg-black/80 "
                ...
                {links.map((links, i) => (
                    <div key={links}>
                                <motion.div
                                    ...
                                    className={router.pathname === links.href ? "font-medium p-2 relative after:content[''] after:absolute after:bottom-0 after:left-0 after:bg-black after:w-2/5 after:h-[3px] after:transition after:duration-300 after:ease-in-out hover:after:w-full" : "font-medium p-2 relative after:content[''] after:absolute after:bottom-0 after:left-0 after:bg-black after:w-[] after:h-[3px] after:transition after:duration-300 after:ease-in-out hover:after:w-full"}
