...
export default function Header(props) {
    ...
    <header className="sticky top-0 z-10 flex justify-between h-24 pt-4 mx-auto max-full"
    // className={styles.header}
    >
        <motion.div className="self-center w-56 ml-16 uppercase border-transparent cursor-pointer h-14"
        ...
        <div className="flex flex-col justify-center w-2/5 mr-16 text-lg xl:w-48">
            <ul className="links"
