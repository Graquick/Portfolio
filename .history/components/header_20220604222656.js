...
export default function Header() {
    ...
    <header className="max-w-7xl mx-auto px-4 sm:px-6 flex justify-between items-center border-b-2 border-gray-100 py-6"
    // className={styles.header}
    >
        <motion.div className="uppercase border-transparent text-3xl font-medium cursor-pointer h-50px bg-slate-500"
            exit={{ y: -100}}
            initial={{ y: -100 }}
        ...
        >
            <Link href="/">
                <div className="flex align-center justify-center w-200px "
