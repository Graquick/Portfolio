...
export default function Header() {
    ...
    <header className="sticky top-0 z-10 flex justify-between w-full border-b border-gray-200 bg-greed-400 h-100px align-center"
    ...
    >
        ...
        >
            {links.map((links, i) => (
                <motion.div className="h-50px w-100px"
                    key={links.id}
