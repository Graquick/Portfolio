...
export default function Header() {
    ...
    <header className="sticky top-0 z-10 flex justify-between w-full bg-gray-500 border-b border-gray-200 h-200px align-center"
    // className={styles.header}
    >
        <motion.div className="flex justify-center text-3xl font-normal uppercase bg-red-500 border border-transparent rounded-lg cursor-pointer h-50px w-200px align-center"
            exit={{ y: -100}}
            initial={{ y: -100 }}
