...
const modalContent = [
  ...
  { id: 1, setShowTrue: () => setShowModal(true), src: 'boots', setShowFalse: () => setShowModal(false), modalType: <CssModal /> },
  { id: 1, setShowTrue: () => setShowModal(true), src: 'boots', setShowFalse: () => setShowModal(false), modalType: <JavaModal /> },
  { id: 1, setShowTrue: () => setShowModal(true), src: 'boots', setShowFalse: () => setShowModal(false), modalType: <ReactModal /> },
  { id: 1, setShowTrue: () => setShowModal(true), src: 'boots', setShowFalse: () => setShowModal(false), modalType: <NextModal /> },
]
