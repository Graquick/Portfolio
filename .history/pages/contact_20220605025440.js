...
const Contact = () => {
    ...
    return ( 
        <div className="px-5 py-0 ">
            ...
            <motion.main className="min-h-screen max-w-6xl bg-orange-300 m-auto flex flex-col justify-center flex-1 px-0 py-16 align-center"
                variants={container}
                initial="hidden"
                animate="visible"
                exit="exit"
            ...
            >
                ...
                <div className="flex justify-center align-center max-w-4xl h-96">
                    <div className="m-4 py-4 px-6 text-left no-underline shadow-md rounded-xl bg-orange-50 w-3/5 h-full flex flex-col">
