...
const modalContent = [
  ...
  { id: 2, setShowTrue: () => setShowModal(true), src: 'boots', setShowFalse: () => setShowModal(false), modalType: <CssModal /> },
  { id: 3, setShowTrue: () => setShowModal(true), src: 'boots', setShowFalse: () => setShowModal(false), modalType: <JavaModal /> },
  { id: 4, setShowTrue: () => setShowModal(true), src: 'boots', setShowFalse: () => setShowModal(false), modalType: <ReactModal /> },
  { id: 5, setShowTrue: () => setShowModal(true), src: 'boots', setShowFalse: () => setShowModal(false), modalType: <NextModal /> },
]
  ...
  return (
    <div className="px-5 py-0" >
      ...
      {/* <SneakersLM  /> */}
      <SneakersLM showModal={showModal} setShowModal={setShowModal} />
