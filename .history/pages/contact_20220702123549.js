        ...
        <div className="px-5 transition duration-500 bg-gray-200 pt-28 dark:bg-neutral-800 lg:px-0">
            ...
            >
                ...
                <motion.div className={styles.grid} variants={gridVariants}>
                    <div className="flex flex-col justify-around px-12 py-4 text-left no-underline shadow-md bg-white/80 backdrop-blur-sm dark:bg-black/50 2xl:px-4 2xl:items-center xl:p-12 lg:p-0">
                        <h1 className="text-[2.5rem] 2xl:w-[85%] lg:text-[1rem]">Let&apos;s get in touch</h1>
                        <p className="font-medium text-[1.125rem] 2xl:w-[85%] xl:text-[1.5rem]">I&apos;m looking forward to working on a new project with you.</p>
                            ...
                            {cardIconsParent.map((cards, i) => (
                                <div className={styles.cardIconsParent}
                                    ...
                                    <div className={styles.cardIconText}>
                                        ...
                                        <p className="text-[1.5rem] font-light font-roboto 2xl:text-[1.25rem] xl:text-[1.5rem]">{cards.pholder}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
