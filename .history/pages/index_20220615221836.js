...
export default function Home() {
  ...
  const [showCModal, setShowModal] = useState(false);
  const [showModal, setShowModal] = useState(false);
...
const modalContent = [
  ...
  return (
    <div className="px-5 py-0" >
      ...
      <CssModal showModal={showModal} setShowModal={setShowModal} />
      <JavaModal showModal={showModal} setShowModal={setShowModal} />
