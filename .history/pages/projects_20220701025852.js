                    ...
                    {aboutContent.map((tags, i) => {
                        return (
                            ...
                            >
                                ...
                                <motion.div className={i % 2 === 0 ? "flex flex-col p-8 mb-8 text-left shadow-md bg-white/80 backdrop-blur-sm dark:bg-black/50 w-full h-[6px] xl:h-[485px] xl:p-[1.5rem]" : "order-2 flex flex-col p-8 mb-8 text-left shadow-md bg-white/80 backdrop-blur-sm dark:bg-black/50 w-full h-[6px] xl:h-[485px] xl:p-[1.5rem] lg:order-1"}
