          ...
          >
              ...
              >
                ...
                <motion.div className="h-full flex flex-col p-8 mb-8 text-left shadow-md bg-white/80 backdrop-blur-sm dark:bg-black/50 xl:h-4/5" 
                  ...
                  animate="visible"
                >
                  <h1 className="font-medium text-[5rem] mb-4 dark:text-gray-200 2xl:text-[4rem]2xl:mb-0">Web Developer</h1>
                  <p className="text-[3rem] mb-8 dark:text-gray-200 2xl:mb-2">Brima Freeman</p>
