                            ...
                            {cardIconsParent.map((cards, i) => (
                                <div className={styles.cardIconsParent}
                                    ...
                                    <div className={styles.cardIconText}>
                                        <h3>{cards.title}</h3>
                                        <p class="text-[1.5rem] font-medium font-roboto">{cards.pholder}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
                        ...
                        <div className={styles.formContent}>
                            <div className={styles.formNameContent}>
                                <div className={styles.formInputTheme}>
                                    ...
                                    <input name="fullname" type="text" id="fullname" placeholder="Name" required class="dark:text-"
                                ...
                                <div className={styles.formInputTheme}>
                                    ...
                                    <input name="email" type="email" id="email" placeholder="Email" required class="dark:text-"
                            ...
                            <div className={styles.MessageContent}>
                                <div className={styles.formInputTheme}>
                                    ...
                                    <input name="subject" type="text" id="subject" placeholder="Subject" required class="dark:text-"
                                ...
                                >
                                    ...
                                    <textarea name="message" id="message" rows="5" cols="1" required class="dark:text-"
