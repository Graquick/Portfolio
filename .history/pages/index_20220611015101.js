...
const modalContent = [
  { id: 1, setShowBLMTrue: () => setShowBLM(true), src: 'boots', setShowBLMFalse: () => setShowBLM(false), modalName: SneakersLM, func: showBLM, setfunc: setShowBLM },
  { id: 2, setShowBLMTrue: () => setShowBLM(true), src: 'sneakers', setShowBLMFalse: () => setShowBLM(false), modalName: SneakersLM, func: showBLM, setfunc: setShowBLM }
]
