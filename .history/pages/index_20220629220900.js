          ...
          >
              ...
              >
                ...
                <motion.div className="h-[95%] flex flex-col p-8 text-left shadow-md bg-white/80 backdrop-blur-sm dark:bg-black/50" 
                  ...
                  animate="visible"
                >
                  <h1 className="font-medium text-[5rem] mb-4 dark:text-gray-200 2xl:text-[4rem] xl:text-[2.25rem] xl:mb-2">Web Developer</h1>
                  <p className="text-[3rem] mb-8 dark:text-gray-200 2xl:text-[2rem] xl:text-[1.25rem] xl:mb-4">Brima Freeman</p>
                  <motion.div className="w-[fit-content] text-[1.65rem] p-3 uppercase relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:bg-black after:w-[0%] after:h-[2px] after:flex after:items-end after:justify-end after:transition-all after:duration-150 hover:after:w-full dark:text-gray-200 dark:after:bg-gray-200 2xl:p-0 2xl:text-[1.4rem] 2xl:after:-bottom-2 xl:text-[.7rem]"
