        ...
        {/* ModalS */}
          ...
          >
              ...
              >
                ...
                <motion.div className="row-span-3 overflow-hidden bg-blue-500 rounded-md z-5 xl:order-3 xl:row-span-2 xl:col-span-2 lg:h-[515px] lg:ored" variants={gridVariants}
                >
