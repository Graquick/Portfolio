    ...
    <div className="flex flex-col justify-between min-h-screen px-5 py-0">
      ...
      <main className="flex flex-col justify-center px-0 py-16 align-center">
        ...
        <p className="mx-0 my-16 text-2xl leading-normal text-center">
          I&apos;m a <code className="p-3 text-base bg-gray-200 rounded-md">WEB DEVELOPER</code>. You can either browse my portfolio through the links below.
        </p>

        <div className="flex flex-wrap justify-center max-w-3xl m-auto align-center">
          <Link href="/">
