...
const Contact = () => {
  ...
  const router = useRouter();
    ...
    return ( 
      <>
        <div className="px-5 transition duration-500 bg-gray-200 pt-28 dark:bg-neutral-800">
            <Head>
            ...
            >
                ...
                <motion.div className={styles.grid} variants={gridVariants}>
                    ...
                    <form className="pt-4 pb-8 pl-12 pr-12 text-left no-underline shadow-md text-inherit bg-white/80 backdrop-blur-sm dark:bg-black/50 2xl:py-0 2xl:px-4"
