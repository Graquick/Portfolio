...
setShowFalse: () => setShowCModal(false), modalType: <CssModal /> },
  ...
  { id: 3, setShowTrue: () => setShowJModal(true), title: <div className={styles.bfBlog}><div className={styles.bfBlogLogo}>bf</div><div className={styles.bfBlogLogo2}>blog ste</div></div>, setShowFalse: () => setShowJModal(false), modalType: <JavaModal /> },
