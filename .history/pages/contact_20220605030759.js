        ...
        <div className="px-5 py-0 ">
            ...
            >
                ...
                <div className="flex justify-center align-center max-w-6xl h-96 bg-slate-600">
                    <div className="m-4 py-4 px-6 text-left no-underline shadow-md rounded-xl bg-orange-50 w-1/4 h-full flex flex-col">
                    ...
                    <form className="m-4 pt-4 px-12 pb-8 no-underline shadow-md rounded-xl w-3/4"
