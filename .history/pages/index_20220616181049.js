...
>
  ...
  <div className={styles.markCity}>apparell.com</div>,
setShowFalse: () => setShowCModal(false), modalType: <CssModal /> },
  ...
  { id: 4, setShowTrue: () => setShowRModal(true), title: <div className={styles.calculator}>Mancho Calco!</div>, setShowFalse: () => setShowRModal(false), modalType: <ReactModal /> },
]
