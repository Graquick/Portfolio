    ...
    >
      ...
      <main className="flex flex-col justify-center px-0 py-16 align-center">
        ...
        <motion.p className="mx-0 my-16 text-2xl leading-normal text-center"
          variants={children}
        >
          I&apos;m a <code className="p-3 text-base rounded-md bg-black-300">WEB DEVELOPER</code>. You can either browse my portfolio through the links below.
        </motion.p>
        ...
        >
          <Link href="/">
            ...
            // className={styles.card}
              whileHover={{ y: -10, x: -10, borderColor: "#4bb543", borderWidth: "2px", transition: { duration: .1 } }}
          ...
          <Link href="/about">
            <motion.a className="max-w-xs p-6 m-4 text-left no-underline border border-gray-200 border-solid cursor-pointer rounded-xl"
              whileHover={{ y: -5, x: -5, borderColor: "#4bb543", borderWidth: "2px", transition: { duration: .1 } }}
              whileTap={{ scale: 0.9, transition: { duration: .001 } }}
            >
