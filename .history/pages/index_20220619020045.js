...
const modalContent = [
  ...
  className="absolute top-[2.5rem] -right-8 w-[26px] h-[26px] transition-all duration-500 ease-in-out group-hover:fill-black group-hover:stroke-black dark:"
  width={26}
  height={24}
  viewBox="0 0 26 24"
  fill="none"
...
>
  <rect x="7.2" y="5.2" width="17.6" height="17.6" rx="1.8" strokeWidth="2.4" className="fill-white/80" />
  <rect
    x="1.2"
    y="1.2"
    width="17.6"
    ...
    strokeWidth="2.4"
  />
  <circle cx={13} cy={7} r="2.5" className="stroke-white/80"/>
