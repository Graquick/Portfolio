...
const modalContent = [
  { id: 1, setShowTrue: () => setShowModal(true), title: <div className="font-[Arial, Helvetica, sans-serif] text-[4rem] font-bold text-gray-200 cursor-pointer transition-all duration-150 ease-in-out relative hover:text-black group dark:text-zinc-600 dark:hover:text-zinc-300 lg:text-[1rem]">  <svg
          ...
          >
              ...
              >
                ...
                <motion.div className="h-[95%] flex flex-col p-8 text-left shadow-md bg-white/80 backdrop-blur-sm dark:bg-black/50" 
                  ...
                  animate="visible"
                >
                  <h1 className="font-medium text-[5rem] mb-4 dark:text-gray-200 2xl:text-[4rem] xl:text-[3rem] lg:text-[2.35rem]">Web Developer</h1>
                ...
                <div className="lg:order-2">
                      <div className="h-fit w-fit text-[1.2rem] font-semibold text-gray-400 uppercase flex items-center justify-center bg-white dark:text-gray-500">
                        selected projects
                      </div>
