...
const modalContent = [
  ...
  { id: 2, setShowTrue: () => setShowCModal(true), title: <div className={styles.markCity}>markcity</div>, setShowFalse: () => setShowCModal(false), modalType: <CssModal /> },
  { id: 3, setShowTrue: () => setShowJModal(true), title: <div className={stylesHeader.logo}>bfblog</div>, setShowFalse: () => setShowJModal(false), modalType: <JavaModal /> },
