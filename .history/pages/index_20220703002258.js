        ...
        {/* ModalS */}
          ...
          >
              ...
              >
                ...
                <motion.div className="row-span-3 shadow-md overflow-hidden rounded-md z-5 xl:order-3 xl:row-start-span-2 xl:col-start-span-2 lg:h-[510px] lg:order-3 lg:row-start-3 col-start-1" variants={gridVariants}
                >
