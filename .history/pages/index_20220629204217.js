        ...
        {/* ModalS */}
          ...
          >
              ...
              >
                ...
                <motion.div className="h-full flex flex-col p-8 mb-8 text-left shadow-md bg-white/80 backdrop-blur-sm dark:bg-black/50 xl:h-4/5" 
                  // className={styles.helloCard}
                  variants={gridVariants}
                  initial="hidden"
                  animate="visible"
                >
                  <h1 className="font-medium text-[5rem] mb-4 dark:text-gray-200 2xl:text-[4rem]">Web Developer</h1>
                  <p className="text-[3rem] mb-8 dark:text-gray-200 2xl:text-[2rem] 2xl:mb-[1.5rem]">Brima Freeman</p>
                  <motion.div className="w-[fit-content] text-[1.65rem] p-3 uppercase relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:bg-black after:w-[0%] after:h-[2px] after:flex after:items-end after:justify-end after:transition-all after:duration-150 hover:after:w-full dark:text-gray-200 dark:after:bg-gray-200 2xl:p-0 2xl:text-[1.4rem] 2xl:after:-bottom-2"
                ...
                <div className="h-full w-fit text-[1.2rem] font-semibold text-gray-400 uppercase flex items-center justify-center bg-white dark:text-gray-500">
                  selected projects
                </div>

                <motion.div className="w-full overflow-hidden shadow-md bg-white/80 backdrop-blur-sm cursor-grab h-3/5 relative before:content-['scrollable_\1f91a'] before:absolute before:bottom-0 before:left-0 before:font-medium before:text-[1.125rem] before:w-[140px] before:h-[30px] before:py-0 before:px-2 self-start before:text-gray-400 before:cursor-default dark:bg-black/50 dark:text-gray-200 2xl:self-auto 2xl:h-full"
