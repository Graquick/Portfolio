...
const About = () => {
  ...
  const currentTheme = theme === "system" ? systemTheme : theme;
    ...
    const container = {
      ...
      </svg>snap</div>, desc: <p className="xl:text-[1.1rem]">Snap tested my ability to create dropdown navigation menus, a common pattern on larger sites. It also provided some nice basic layout challenges.<br/><br/><div className="flex flex-wrap w-full gap-[.75rem] mt-2 h-fit xl:gap-2"><span className="py-1 px-2 text-black shadow-md rounded-md font-bold cursor-default text-[1.1rem] w-fit flex items-center justify-center gap-2 xl:text-[.9rem] bg-white dark:shadow-neutral-500 ">Figma <Icon icon="logos:figma" className="text-[1.2rem] xl:text-[.9rem]"/></span><span className="py-1 px-2 text-black shadow-md rounded-md cursor-default w-fit flex items-center justify-center gap-1 text-[2rem] xl:text-[1.45rem] bg-white dark:shadow-neutral-500 "><Icon icon="logos:nextjs" /></span><span className="py-1 px-2 text-black shadow-md rounded-md font-medium cursor-default text-[1.2rem] w-fit flex items-center justify-center gap-1 xl:text-[.9rem] bg-white dark:shadow-neutral-500 ">React<Icon icon="akar-icons:react-fill" className="text-blue-400"/></span><span className="py-1 px-2 text-black shadow-md rounded-md cursor-default w-fit flex items-center justify-center gap-1 text-[1.1rem] font-medium font-roboto xl:text-[.9rem] bg-white dark:shadow-neutral-500 "><Icon icon="bxl:tailwind-css" className="text-blue-400" />tailwindcss</span><span className="py-1 px-2 text-black shadow-md rounded-md cursor-default text-[1.2rem] w-fit flex items-center justify-center gap-1 xl:text-[.9rem] bg-white dark:shadow-neutral-500 "><Icon icon="logos:headlessui" /></span><span className="py-1 px-2 text-black shadow-md rounded-md cursor-default w-fit flex items-center justify-center gap-1 text-[1.2rem] font-extrabold tracking-tighter xl:text-[.9rem] bg-white dark:shadow-neutral-500 ">Framer Motion<Icon icon="logos:framer"/></span></div></p>, src: 'snap-projects-mobile-hero', srcdark: 'snap-projects-mobile-hero-dark', href: 'https://brimasnap.vercel.app/', hrefp: 'live site'},
