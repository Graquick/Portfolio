...
const modalContent = [
  { id: 1, setShowModalTrue: () => setShowModal(true), src: 'boots'}
]

const modalType = [
  { id: 1, modalName: BootsLM, func: showModal, setFunc: setShowModal, setShowModalFalse: () => setShowModal(false) }
]
                      ...
                      return (
                        ...
                        >
                            ...
                            {modalType.map((type) => {
                              return (
                                <div key={type}>
                                  <AnimatePresence exitBeforeEnter onExitComplete={type.setShowModalFalse}>
                                    <type.modalName showModal={type.func} setfunc={type.setfunc} />
                                  </AnimatePresence>
                                </div>
                              )
                            })}
