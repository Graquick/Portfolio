...
const modalContent = [
  ...
  { id: 3, setShowTrue: () => setShowRModal(true), src: 'React', setShowFalse: () => setShowRModal(false), modalType: <ReactModal /> },
  { id: 3, setShowTrue: () => setShowNModal(true), title: 'pumpkin', setShowFalse: () => setShowNModal(false), modalType: <NextModal /> },
]
