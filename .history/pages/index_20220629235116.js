        ...
        {/* ModalS */}
          ...
          >
              ...
              >
                ...
                <div className="h-full w-fit text-[1.2rem] font-semibold text-gray-400 uppercase flex items-center justify-center bg-white dark:text-gray-500 opacity-20">
                  selected projects
                </div>

                <motion.div className="w-full overflow-hidden shadow-md bg-white/80 backdrop-blur-sm cursor-grab h-3/5 relative before:content-['scrollable_\1f91a'] before:absolute before:bottom-0 before:left-0 before:font-medium before:text-[1.125rem] before:w-[140px] before:h-[30px] before:py-0 before:px-2 before:text-gray-400 before:cursor-default after:content-['selected projects'] after:absolute after:top-4 after:left-0 after:text-white after:bg-blue-400 after:w-fit after:h-[30px] dark:bg-black/50 dark:text-gray-200 2xl:h-[65%]"
