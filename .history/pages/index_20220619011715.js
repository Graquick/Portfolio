      ...
      {/* ModalS */}
        ...
        >
            ...
            >
              ...
              <motion.div className="w-full overflow-hidden shadow-md bg-white/80 backdrop-blur-sm cursor-grab h-[55%] mt-3 relative before:content[''] before:absolute before:bottom-0 before:left-0 before:font-medium before:text-[1.125rem] before:w-[140px] before:h-[30px] py-0 px-2 text-[#a8a8a8]"
