...
const modalContent = [
  ...
  { id: 2, setShowTrue: () => setShowCModal(true), title: <div className={styles.markCity}>markcity<Icon icon="uil:circuit" /> </div>, setShowFalse: () => setShowCModal(false), modalType: <CssModal /> },
