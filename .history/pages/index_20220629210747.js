...
setShowFalse: () => setShowCModal(false), modalType: <ApparellModal /> },
  ...
  return (
      <div className="px-5 py-0 lg:p-0 transition duration-500 h-screen bg-gray-200 dark:bg-neutral-800" >
        <Head>
