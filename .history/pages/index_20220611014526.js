...
export default function Home() {
  ...
  const [showModal, setShowBLM] = useState(false);
...
const modalContent = [
  { id: 1, setShowBLMTrue: () => setShowBLM(true), src: 'boots', setShowBLMFalse: () => setShowBLM(false), modalName: BootsLM, func: showBLM, setfunc: setShowBLM, }
]
