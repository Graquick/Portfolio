      ...
      >
        ...
        >
          {mainContent.map((tags, i) => {
            return (
              <Link href={tags.href}>
                <motion.div className=" p-4 text-left no-underline border border-gray-200 border-solid cursor-pointer h-48 rounded-xl w-72"
                  key={tags.id}
                  initial="offscreen"
                  whileInView="onscreen"
                  viewport={{ once: true, amount: .8 }}
                >
                  <h2 className="mx-0 mt-0 mb-4 text-3xl uppercase">{tags.tiitle}</h2>
