...
const About = () => {
    ...
    const container = {
      ...
      </svg>snap</div>, desc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', src: {dark ? 'snap-projects-mobile-hero-dark' : 'snap-projects-mobile-hero'}, href: '/'},
