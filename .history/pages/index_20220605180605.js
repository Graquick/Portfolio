...
export default function Home() {
  ...
  const mainContent = [
    { id: 1, title: 'Hello!', desc: 'My name is Brima Freeman and I am a web developer. Welcome to my website! I will be the one to show you around.', href: '/journey', src: 'me'}
]
