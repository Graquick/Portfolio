...
const modalContent = [
  { id: 1, setShowTrue: () => setShowModal(true), src: 'sneakers', setShowFalse: () => setShowModal(false), modalName: SneakersLM, func: showModal={showModal}, setfunc: setShowModal={setShowModal }
]
