...
const modalContent = [
  ...
  { id: 2, setShowTrue: () => setShowCModal(true), title: <div className={styles.markCity}>mark.city<Icon icon="uil:circuit" /> </div>, setShowFalse: () => setShowCModal(false), modalType: <CssModal /> },
  { id: 3, setShowTrue: () => setShowJModal(true), title: <div className={styles.bfBlog}>blog.bf</div>, setShowFalse: () => setShowJModal(false), modalType: <JavaModal /> },
