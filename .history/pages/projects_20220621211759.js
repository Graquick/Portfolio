...
const About = () => {
  ...
  const currentTheme = theme === "system" ? systemTheme : theme;
    ...
    const container = {
      ...
      const aboutContent = [
        { id: 1, title: <div className="font-[Arial, Helvetica, sans-serif] text-[4rem] font-bold text-black cursor-pointer transition-all duration-150 ease-in-out relative group dark:text-zinc-300 dark:hover:text-zinc-300">  <svg
