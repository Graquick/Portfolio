...
const About = () => {
  ...
  const currentTheme = theme === "system" ? systemTheme : theme;
    ...
    const container = {
      ...
      </svg>snap</div>, desc: <p>Snap tested my ability to create dropdown navigation menus, a common pattern on larger sites. It also provided some nice basic layout challenges.<br/><br/><span className="font-bold uppercase text-[1.25rem]">Technologies used</span><br /> <div className="flex flex-wrap w-full gap-4 mt-2 h-fit bg-fuchsia-500"><span className="p-1 text-sm text-white bg-black rounded">Figma</span><span className="p-1 text-sm text-white bg-black rounded">Next.js</span><span className="p-1 text-sm text-white bg-black rounded">React</span><span className="p-1 text-sm text-white bg-black rounded">Tailwind CSS</span><span className="p-1 text-sm text-white bg-black rounded">Headless UI</span><span className="p-1 text-sm text-white bg-black rounded">Framer Motion</span></div></p>, src: 'snap-projects-mobile-hero', srcdark: 'snap-projects-mobile-hero-dark', href: 'https://brimasnap.vercel.app/', hrefp: 'live site'},
