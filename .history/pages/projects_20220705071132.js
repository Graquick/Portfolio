                        ...
                        return (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <motion.div className="text-[1.5rem] uppercase h-[45px] w-[fit-content] p-4 relative bottom-0 left-0 flex items-center justify-center border-2 border-black text-black hover:border-green-500 hover:bg-green-500 hover:text-white rounded  dark:text-white dark:border-whitexl:bottom-1"
                                        variants={gridVariants}
