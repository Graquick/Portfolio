...
export default function Home() {
  ...
  return (
    <div className="bg-red-300 px-5 py-0">
      ...
      >
        <div className="bg-green-700 w-full flex flex-col justify-around h-40">
          <motion.h1 className="m-0 text-6xl text-center"
            // className={styles.title}
          >
            My name is <Link href="/"><a>Brima Freeman</a></Link>
          </motion.h1>

          <motion.p className="m-0 text-2xl leading-normal text-center"
