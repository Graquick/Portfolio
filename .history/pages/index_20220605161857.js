...
export default function Home() {
  ...
  return (
    <div className="bg-red-300 px-5 py-0">
      ...
      <motion.main className="bg-gray-500 min-h-screen flex flex-col justify-around px-0 py-16 align-center"
        variants={container}
        initial="hidden"
        animate="visible"
        exit="exit"
      ...
      >
        <div className="bg-sky-700 max-w-4xl mx-auto my-0">
        ...
        <motion.div className="flex bg-sky-700 flex-wrap justify-center m-auto max-w-7xl align-center"
