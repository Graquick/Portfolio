  ...
  const currentTheme = theme === "system" ? systemTheme : theme;
    ...
    const container = {
      ...
      >
        ...
        { id: 2, title: <div className="font-roboto text-[4rem] font-light text-black cursor-default transition-all duration-150 ease-in-out relative group dark:text-white">.apparell</div>, desc: 'In this challenge, I built a beautiful product page. My JS skills were put to the test with a lightbox product gallery and cart functionality!', src: 'apparel-projects-hero', srcdark: 'apparel-projects-hero-dark', href: '/'},
