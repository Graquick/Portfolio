...
>
  ...
  { id: 3, setShowTrue: () => setShowJModal(true), title: <div className={styles.bfBlog}><div className={styles.logo}></div></div>, setShowFalse: () => setShowJModal(false), modalType: <JavaModal /> },
