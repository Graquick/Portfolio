...
const Contact = () => {
    ...
    return ( 
        <div className="px-5 py-0 ">
            ...
            <motion.main className="min-h-screen max-w-7xl bg-orange-300 m-auto flex flex-col justify-center flex-1 px-0 py-16 align-center"
                variants={container}
                initial="hidden"
                animate="visible"
                exit="exit"
            ...
            >
                ...
                <div className="flex justify-center align-center max-w-4xl h-96">
                    <div className="m-4 py-4 px-6 text-left no-underline shadow-md rounded-xl bg-orange-50 w-2/4 h-full flex flex-col">
                        ...
                        <div>
                            {cardIconsParent.map((cards, i) => (
                                <div className="flex align-center bg-red-400"
                                    key={cards.id}>
                                    <div className="w-12 h-12 rounded-full text-2xl shadow-white shadow-md bg-black text-white ml-4 flex align-center justify-center">
