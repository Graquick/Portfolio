...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <main className="flex flex-col justify-around flex-1 min-h-screen px-0 py-16 align-center bg-slate-600">
        ...
        <motion.div className="flex flex-wrap justify-center max-w-6xl m-auto bg-red-300 align-center"
          variants={children}
        >
          <Link href="/">
