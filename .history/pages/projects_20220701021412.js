...
const About = () => {
  ...
  const currentTheme = theme === "system" ? systemTheme : theme;
    ...
    const container = {
      ...
      </svg>snap</div>, desc: <p className="xl:text-[1.1rem]">Snap tested my ability to create dropdown navigation menus, a common pattern on larger sites. It also provided some nice basic layout challenges.<br/><br/><span className="font-medium uppercase text-[1.1rem] text-black xl:text-[.9rem]">Technologies used</span><br /> <div className="flex flex-wrap w-full gap-4 mt-2 h-fit"><span className="p-1 text-black rounded-xl cursor-default text-[1.1rem] w-fit flex items-center justify-center gap-2 xl:text-[.8rem]">Figma <Icon icon="logos:figma" className="text-[1.2rem] xl:text-[1rem]"/></span><span className="text-black cursor-default w-fit flex items-center justify-center gap-1 text-[2rem]"><Icon icon="logos:nextjs" /></span><span className="p-1 text-black cursor-default text-[1.2rem] w-fit flex items-center justify-center gap-1">React<Icon icon="akar-icons:react-fill" className="text-blue-400"/></span><span className="text-black cursor-default w-fit flex items-center justify-center gap-1 text-[1.1rem] font-medium font-roboto"><Icon icon="bxl:tailwind-css" className="text-blue-400" />tailwindcss</span><span className="text-black cursor-default text-[1.2rem] w-fit flex items-center justify-center gap-1"><Icon icon="logos:headlessui" /></span><span className="text-black cursor-default w-fit flex items-center justify-center gap-1 text-[1.2rem] font-extrabold tracking-tighter ">Framer Motion<Icon icon="logos:framer"/></span></div></p>, src: 'snap-projects-mobile-hero', srcdark: 'snap-projects-mobile-hero-dark', href: 'https://brimasnap.vercel.app/', hrefp: 'live site'},
