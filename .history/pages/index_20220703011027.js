        ...
        {/* ModalS */}
          ...
          >
              ...
              >
                ...
                <motion.div className="row-start-3 row-span-3 shadow-md overflow-hidden rounded-md z-5 xl:order-3 xl:row-span-2 xl:col-span-2 lg:h-[510px] lg:order-3 lg:row-3 col-1" variants={gridVariants}
                >
