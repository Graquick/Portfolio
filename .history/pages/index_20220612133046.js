      ...
      <Header variants={pageLoad} />
        ...
        >
          <div className={styles.grid}>
            <div className={styles.helloCard} variants={gridVariants}>
              <h1>Hello</h1>
            ...
            <div className={styles.imgCard} variants={gridVariants}>

            </div>

            <div className={styles.modalCard} variants={gridVariants}>
