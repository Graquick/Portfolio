...
>
  ...
  { id: 3, setShowTrue: () => setShowJModal(true), title: <div className={styles.bfBlog}><div className={styles.blogLogo}>bf</div>div</div>, setShowFalse: () => setShowJModal(false), modalType: <JavaModal /> },
