...
export default function Home() {
  ...
  const mainContent = [
    ...
    { id: 2, title: 'BEGINNING', desc: 'Welcome to my website! I have been looking forward to meeting you. Click the link below to start.', href: '/part-one', href2: 'what i am doing now', src: 'me'},
    { id: 3, title: 'PRESENT', desc: 'Welcome to my website! I have been looking forward to meeting you. Click the link below to start.', href: '/part-one', href2: 'what will i be doing in the future', src: 'me'},
    { id: 4, title: 'NEXT UP', desc: 'Welcome to my website! I have been looking forward to meeting you. Click the link below to start.', href: '/part-one', href2: 'back to the start', src: 'me'}
]

const items = [
  { id: 1, title: 'hello', subtitle: 'this is my item number 1' },
  { id: 2, title: 'hello', subtitle: 'this is my item number 1' },
  { id: 3, title: 'hello', subtitle: 'this is my item number 1' },
  { id: 4, title: 'hello', subtitle: 'this is my item number 1' },
]
