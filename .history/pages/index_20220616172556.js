...
>
  ...
  { id: 3, setShowTrue: () => setShowJModal(true), title: <div className={styles.bfBlog}><div className={styles.bfBlogLogo}>bf</div><div className={styles.blogLogo2}>my blog</div></div>, setShowFalse: () => setShowJModal(false), modalType: <JavaModal /> },
