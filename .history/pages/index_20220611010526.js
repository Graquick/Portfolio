...
import SneakersLM from '../components/Modals/BootsLM';
import Modal from '../components/Modals/BootsLM';
...
const modalContent = [
  { id: 1, setShowModalTrue: () => setShowModal(true), src: 'boots', setShowModalFalse: () => setShowModal(false), func: showModal, setFunc: setShowModal }
]
                      ...
                      return (
                        ...
                        >
                          ...
                          <AnimatePresence exitBeforeEnter onExitComplete={modal.setShowModalFalse}>
                            <Modal showModal={modal.func} setShowModal={modal.setFunc}/>
                          </AnimatePresence>
                        </motion.div>
                      )
                    })}
