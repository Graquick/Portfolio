...
export default function Home() {
  ...
  const [showRModal, setShowJModal] = useState(false);
  const [showJModal, setShowJModal] = useState(false);
...
const modalContent = [
  { id: 1, setShowTrue: () => setShowModal(true), src: 'boots', setShowFalse: () => setShowModal(false), modalType: <HtmlModal /> },
  { id: 2, setShowTrue: () => setShowCModal(true), src: 'banana', setShowFalse: () => setShowCModal(false), modalType: <CssModal /> },
  { id: 3, setShowTrue: () => setShowJModal(true), src: 'me', setShowFalse: () => setShowJModal(false), modalType: <JavaModal /> },
  { id: 3, setShowTrue: () => setShowRModal(true), src: 'me', setShowFalse: () => setShowRModal(false), modalType: <ReactModal /> },
  { id: 3, setShowTrue: () => setShowNModal(true), src: 'me', setShowFalse: () => setShowNModal(false), modalType: <NextModal /> },
]
  ...
  return (
    <div className="px-5 py-0" >
      ...
      <JavaModal showRModal={showRModal} setShowRModal={setShowRModal} />
      <JavaModal showNModal={showNModal} setShowNModal={setShowNModal} />
