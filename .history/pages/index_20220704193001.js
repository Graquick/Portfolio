          ...
          >
              ...
              >
                ...
                >
                  ...
                  <motion.div className="flex items-center justify-center rounded border-2 border-black w-[50%] h-[20%] bg-green-300 text-[1.65rem] text-blue-400 font-medium uppercase relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:bg-blue-400 after:w-[0%] after:h-[2px] after:flex after:items-end after:justify-end after:transition-all after:duration-150 hover:after:w-full dark:text-gray-200 dark:after:bg-gray-200 2xl:p-0 2xl:text-[1.3rem] 2xl:after:-bottom-2 xl:text-[1.2rem] xl:after:h-[1.5px]"
