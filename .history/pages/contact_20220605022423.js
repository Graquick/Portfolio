                        ...
                        <div>
                            <div>
                                ...
                                <div>
                                    ...
                                    <input name="email"
                                    style={errors.email ? { border: "solid 1.5px #ed4337" } : null} type="email" id="email" placeholder="Email" {...register("email", { required: true, pattern: { value: /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i, message: "This is not a valid email address." } })} required/>
