...
export default function Home() {
  ...
  const mainContent = [
    ...
    { id: 1, title: '`What${&apos;}s next`', desc: 'Welcome to my website! I have been looking forward to meeting you. Click the link below to start.', href: '/part-one', href2: 'how i became a web developer', src: 'me'}
]
