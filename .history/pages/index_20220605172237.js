  ...
  return (
    <div className="bg-red-300 px-5 py-0">
      ...
      >
        ...
        <motion.div className="flex bg-sky-700 flex-wrap justify-center aglign-center w-full h-3/5 p-4 gap-4"
          // className={styles.grid}
        >
          {mainContent.map((tags, i) => {
            return (
              <Link href={tags.href}>
                <motion.div className=" p-4 text-left no-underline border border-gray-200 border-solid cursor-pointer h-64 rounded-xl w-72"
                  key={tags.id}
                  initial="offscreen"
                  whileInView="onscreen"
                  viewport={{ once: true, amount: .8 }}
                >
                  <h2 className="mx-0 mt-0 mb-4 text-3xl uppercase">{tags.title} &rarr;</h2>
