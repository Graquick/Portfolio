    ...
    return ( 
        <div className="px-5 py-0 ">
            ...
            >
                ...
                <div className="flex justify-center align-center max-w-7xl m-auto h-96 bg-slate-600">
                    ...
                    <form action="/success" id="form" name="contact" method="POST" data-netlify="true">
                        ...
                        <div className="m-4 pt-4 px-12 pb-8 no-underline shadow-md rounded-xl w-2/4">
                            <div>
                                <div>
