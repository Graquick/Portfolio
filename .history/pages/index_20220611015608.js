...
const modalContent = [
  { id: 1, "setShowTrue": () => setShowModal(true), src: 'sneakers', setShowFalse: () => setShowModal(false), modalName: SneakersLM, func: showModal, setfunc: setShowModal },
  { id: 2, setShowTrue: () => setShowBLM(true), src: 'boots', setShowFalse: () => setShowBLM(false), modalName: BootsLM, func: showBLM, setfunc: setShowBLM }
]
