...
const modalContent = [
  { id: 1, setShowModalTrue: () => setShowModal(true), src: 'boots', setShowModalShowModalFalse: () => setShowModal(false), modalName: "BootsLM", }
]
                    ...
                    {modalContent.map((modal) => {
                      return (
                        ...
                        >
                            ...
                            placeholder="blur"
                            />
                          <AnimatePresence exitBeforeEnter onExitComplete={setShowModalFalse}>
                            <modal.modalName showModal={showModal} setShowModal={setShowModal}/>
                          </AnimatePresence>
                        </motion.div>
                      )
                    })}
