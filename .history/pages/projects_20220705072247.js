                        ...
                        return (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <motion.div className="text-[1.5rem] uppercase h-[45px] w-[fit-content] p-4 relative bottom-0 left-0 flex items-center justify-center bg-neutral-800 text-white dark:text-white dark:bg- xl:bottom-1"
                                        variants={gridVariants}
