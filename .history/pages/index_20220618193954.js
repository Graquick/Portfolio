      ...
      {/* ModalS */}
        ...
        >
            ...
            >
              ...
              <motion.div className="flex flex-col p-8 mb-8 text-left shadow-md bg-white/80 backdrop-blur-sm dark:bg-black/80" 
                // className={styles.helloCard}
                variants={gridVariants}
                initial="hidden"
                animate="visible"
              >
                <h1 className="font-medium text-[5rem] mb-4 dark:text-white">Web Developer</h1>
                <p className="text-[3rem] mb-8 dark:text-white">Brima Freeman</p>
                <motion.div className="w-[fit-content] bg-red-500 text-[1.65rem] p-[.75rem] uppercase relative after:content[''] after:absolute after:bottom-0 after:left-0 after:bg-black after:w-[0%] after:h-[2px] after:flex after:items-end after:justify-end after:transition-all after:duration-150 hover:after:w-full"
                ...
                {/* {currentTheme === "dark" ?
                    (
                      <motion.div className={styles.darkHelloAncor}
                        whileHover={{ x: 10, color: "#fff", transition: { duration: .1 }}}
                        whileTap={{ scale: 0.9 }}
                      >
                        <Link href="/home/myStory">
                          <a>my story &rarr;</a>
                    ...
                    (
                      <motion.div className={styles.helloAncor}
