                    ...
                    {aboutContent.map((tags, i) => {
                        return (
                            ...
                            >
                                ...
                                <motion.div className={i % 2 === 0 ? "overflow-hidden shadow-md w-full h-[675px] flex flex-col justify-center order-1 xl:h-[520px]" : "overflow-hidden shadow-md w-full h-[675px] flex flex-col justify-center order-1 xl:h-[520px]"}
                                    variants={gridVariants}
                                >
