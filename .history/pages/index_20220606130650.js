...
export default function Home() {
  ...
  const mainContent = [
    ...
    { id: 2, title: 'BEGINNING', desc: 'Welcome to my website! I have been looking forward to meeting you. Click the link below to start.', href: '/part-one', href2: 'how i became a web developer', src: 'me'},
    { id: 3, title: 'PRESENT', desc: 'Welcome to my website! I have been looking forward to meeting you. Click the link below to start.', href: '/part-one', href2: 'how i became a web developer', src: 'me'},
    { id: 4, title: 'NEXT UP', desc: 'Welcome to my website! I have been looking forward to meeting you. Click the link below to start.', href: '/part-one', href2: 'how i became a web developer', src: 'me'}
]
