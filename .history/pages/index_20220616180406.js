...
>
  ...
  <div className={styles.markCity}>apparell
    <svg
    viewBox="0 0 63 72"
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    preserveAspectRatio="none"
    >
      <rect y={11} width="48" height={48} className={styles.rectBehind}/>
      <rect x={21} width="48" height={48} className={styles.rectMiddle}/>
      <rect x={8} y={24} width="48" height="48" className={styles.rectFront}/>
    </svg>
  </div>,
setShowFalse: () => setShowCModal(false), modalType: <CssModal /> },


  { id: 3, setShowTrue: () => setShowJModal(true), title: <div className={styles.bfBlog}><div className={styles.bfBlogLogo}>bf</div><div className={styles.bfBlogLogo2}>my blog</div></div>, setShowFalse: () => setShowJModal(false), modalType: <JavaModal /> },


  { id: 4, setShowTrue: () => setShowRModal(true), title: <div className={styles.snap}>calculate!</div>, setShowFalse: () => setShowRModal(false), modalType: <ReactModal /> },
]
