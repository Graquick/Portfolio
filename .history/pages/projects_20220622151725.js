  ...
  const currentTheme = theme === "system" ? systemTheme : theme;
    ...
    const container = {
      ...
      >
        ...
        { id: 2, title: <div className="font-roboto text-[4rem] font-light text-black cursor-default transition-all duration-150 ease-in-out relative group dark:text-white">.apparell</div>, desc: <In this challenge, you${&apos;}ll build a beautiful product page. Well be putting your JS skills to the test with a lightbox product gallery and cart functionality!`, src: 'apparel-projects-hero', srcdark: 'apparel-projects-hero-dark', href: '/'},
