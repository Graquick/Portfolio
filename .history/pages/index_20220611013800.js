...
export default function Home() {
  ...
  const [showSLM, setShowSLM] = useState(tru);
...
const modalContent = [
  { id: 1, setShowModalTrue: () => setShowSLM(true), src: 'boots', setShowSLMFalse: () => setShowSLM(false), modalName: BootsLM, func: showSLM, setfunc: setShowSLM, }
]
