                        ...
                        >
                            {cardIconsParent.map((cards, i) => (
                                <div className={styles.cardIconsParent}
                                    key={cards.id}>
                                    <div className="w-[50px] h-[50px] rounded-full mr-8 bg-black flex justify-center items-center text-[1.4rem] dark:bg-white"
                                      // className={styles.cardIcon}
                                    >
                                        <Icon className="text-white transition-all duration-300 ease-in-out dark:text-black"
