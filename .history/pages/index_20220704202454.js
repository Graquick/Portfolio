          ...
          >
              ...
              >
                ...
                >
                  ...
                  <motion.div className="flex items-center justify-center rounded border-2 border-black text-white w-[50%] h-[20%]  text-[1.65rem] uppercase relative dark:text-black dark:bg-gray-200 2xl:p-0 2xl:text-[1.3rem] 2xl:after:-bottom-2 xl:text-[1.2rem] xl:after:h-[1.5px]"
