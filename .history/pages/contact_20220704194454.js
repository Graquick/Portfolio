            ...
            >
                ...
                <motion.div className={styles.grid} variants={gridVariants}>
                    ...
                    >
                        ...
                        <motion.div className="cursor-pointer ml-8 w-[12rem] h-[3rem] text-[1.5rem] p-3 relative flex items-center justify-center bg-green-400 text-white rounded  dark:text-black dark:bg-gray-200 2xl:p-0 2xl:text-[1.3rem] 2xl:after:-bottom-2 xl:text-[1.2rem] xl:after:h-[1.5px] lg:text-[1rem]"
