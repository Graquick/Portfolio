          ...
          >
              ...
              >
                ...
                <motion.div id="/" className="h-[95%] flex flex-col p-8 text-left shadow-md bg-white/80 backdrop-blur-sm dark:bg-black/50" 
                  ...
                  animate="visible"
                >
                  <h1 className="font-medium text-[5rem] mb-4 dark:text-gray-200 2xl:text-[3.75rem] 2xl:mb-2 xl:text-[3rem] lg:text-[2.5rem] lg:mb-2">Web Developer</h1>
                  <p className="text-[3rem] mb-8 dark:text-gray-200 2xl:text-[2rem] 2xl:mb-3 xl:text-[1.75rem] xl:mb-[1.5rem] lg:mb-[1rem]">Brima Freeman</p>
                ...
                <div className="lg:order-2">
                      <div className="h-fit w-fit text-[1.2rem] font-semibold text-gray-400 uppercase flex items-center justify-center dark:text-gray-500 xl: lg:text-[.8rem]">
                        selected projects
                      </div>
