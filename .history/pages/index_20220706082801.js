        ...
        {/* ModalS */}
          ...
          >
              ...
              >
                ...
                <motion.div id="/" className="h-[100%] flex flex-col p-8 text-left shadow-md bg-white/80 backdrop-blur-sm dark:bg-neutral-700" 
                ...
                >
                  ...
                  <motion.div className="cursor-pointer flex items-center justify-center bg-neutral-800 text-white w-[50%] h-[20%] text-[1.65rem] uppercase relative 2xl:p-0 2xl:text-[1.3rem] 2xl:after:-bottom-2 xl:text-[1.2rem] xl:after:h-[1.5px] dark:bg-neutral-200 dark:text-black"
