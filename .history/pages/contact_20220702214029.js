                        ...
                        <div className={styles.formContent}>
                            <div className={styles.formNameContent}>
                                <div className={styles.formInputTheme}>
                                    ...
                                    <input name="fullname" type="text" id="fullname" placeholder="Name" required className="dark:text-black" className="peer"
                                    ...
                                    <p className="invisible font-light text-red-500 peer-invalid:visible">
