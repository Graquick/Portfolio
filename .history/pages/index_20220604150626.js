      ...
      <main className="flex flex-col justify-center px-0 py-16 align-center">
        ...
        >
          <Link href="/">
            ...
            >
              <h2 className="mx-0 mt-0 mb-4 leading-normal">My Projects &rarr;</h2>
              <p className="text-xl leading-normal">Explore my latest work including Frontend and Backend development.</p>
            </a>
          </Link>
        </div>
      </main>
