...
import HtmlModal from '../components/Modals/CssModal';
import HtmlModal from '../components/Modals/JavaModal';
...
const modalContent = [
  ...
  { id: 2, setShowTrue: () => setShowModal(true), src: 'banana', setShowFalse: () => setShowModal(false), modalType: <CssModal /> },
  { id: 3, setShowTrue: () => setShowModal(true), src: 'me', setShowFalse: () => setShowModal(false), modalType: <JavaModal /> },
]
