                        ...
                        return (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <motion.div className="text-[1.5rem] uppercase h-[60px] w-[fit-content] p-2 relative bottom-0 left-0 bg-black text-white rounded  dark:text-gray-200 dark:after:bg-gray-200 xl:bottom-1"
                                        variants={gridVariants}
