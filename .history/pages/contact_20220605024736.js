...
const Contact = () => {
    ...
    return ( 
        <div className="px-5 py-0 ">
            ...
            <motion.main className="min-h-screen max-w-5xl bg-orange-300 m-auto flex flex-col justify-center flex-1 px-0 py-16 align-center"
                variants={container}
                initial="hidden"
                animate="visible"
                exit="exit"
            ...
            >
                <h1 className="m-0 leading-tight text-5xl font-medium text-center">
                    Contact
                </h1>

                <p className="mt-8 mx-0 mb-12 leading-normal cursor-default text-center text-3xl">
                    Start by filling in the form, and I will get back to you as soon as possible.
                </p>

                <div className="flex justify-center align-center max-w-4xl h-96">
                    <div className="m-4 py-4 px-12 text-left no-underline shadow-md rounded-xl bg-orange-50 w-2/5 h-full flex flex-col">
                        <h1 className="m-0 leading-tight text-2xl font-medium">Let&apos;s get in touch</h1>
