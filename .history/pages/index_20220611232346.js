...
const modalContent = [
  ...
  { id: 1, setShowTrue: () => setShowSLM(true), src: 'banana', setShowFalse: () => setShowSLM(false), modalType: <BootsLM showBLM={showSLM} setShowBLM={setShowSLM} /> },
  { id: 2, setShowTrue: () => setShowModal(true), src: 'sneakers', setShowFalse: () => setShowModal(false), modalType: <SneakersLM showModal={showModal} setShowModal={setShowModal} /> },
]
