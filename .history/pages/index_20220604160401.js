  ...
  return (
    ...
    >
      ...
      <main className="flex flex-col justify-around flex-1 px-0 py-16 align-center">
        ...
        >
          <Link href="/">
            <motion.a className="max-w-xs p-6 m-1 text-left no-underline border border-gray-200 border-solid cursor-pointer rounded-xl"
          ...
          <Link href="/contact">
            <motion.a className="max-w-xs p-6 m-1 text-left no-underline border-2 border-black border-solid cursor-pointer rounded-xl"
