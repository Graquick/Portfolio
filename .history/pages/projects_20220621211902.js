  ...
  const currentTheme = theme === "system" ? systemTheme : theme;
    ...
    const container = {
      ...
      >
        ...
        <rect
          className="fill-black stroke-black group-hover:fill-black group-hover:stroke-black dark:fill-white dark:stroke-white dark:group-hover:fill-zinc-300 dark:group-hover:stroke-zinc-300"
          x="1.2"
          y="1.2"
          width="17.6"
          height="17.6"
