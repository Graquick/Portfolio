...
const modalContent = [
  { id: 1, setShowTrue: () => setShowBLM(true), src: 'sneakers', setShowBLMFalse: () => setShowBLM(false), modalName: SneakersLM, func: showBLM, setfunc: setShowBLM },
  { id: 2, setShowTrue: () => setShowBLM(true), src: 'boots', setShowBLMFalse: () => setShowBLM(false), modalName: BootsLM, func: showBLM, setfunc: setShowBLM }
]
