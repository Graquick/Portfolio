                        ...
                        return (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <motion.div className="text-[1.5rem] uppercase h-[45px] w-[fit-content] p-2 relative bottom-0 left-0 bg-green-500 text-white rounded  dark:text-black dark:bg-gray-200 xl:bottom-1"
                                        variants={gridVariants}
