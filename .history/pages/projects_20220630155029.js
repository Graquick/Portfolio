                    ...
                    {aboutContent.map((tags, i) => {
                        return (
                            ...
                            >
                                ...
                                <motion.div className={i % 2 === 0 ? "flex flex-col p-8 mb-8 text-left shadow-md bg-white/80 backdrop-blur-sm dark:bg-black/50 w-full h-[625px] xl:h-[480px]" : "order-2 flex flex-col p-8 mb-8 text-left shadow-md bg-white/80 backdrop-blur-sm dark:bg-black/50 w-full h-[625px] xl:h-[480px]"}
                                ...
                                <motion.div className={i % 2 === 0 ? "overflow-hidden shadow-md w-full h-[675px] flex flex-col justify-center order-1" : "overflow-hidden shadow-md w-full h-[675px] flex flex-col justify-center order-1"}
                                    variants={gridVariants}
                                >
