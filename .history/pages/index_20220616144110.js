...
const modalContent = [
  ...
  { id: 3, setShowTrue: () => setShowJModal(true), title: 'JavaScript', setShowFalse: () => setShowJModal(false), modalType: <JavaModal /> },
  { id: 4, setShowTrue: () => setShowRModal(true), title: 'React', setShowFalse: () => setShowRModal(false), modalType: <ReactModal /> },
  { id: 5, setShowTrue: () => setShowNModal(true), title: 'NextJS', setShowFalse: () => setShowNModal(false), modalType: <NextModal /> },
]
