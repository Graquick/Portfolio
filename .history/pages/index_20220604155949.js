...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <main className="flex flex-col flex-1 px-0 py-16 align-center">
        ...
        <motion.div className="flex flex-wrap justify-center m-auto max-w-7xl align-center bg-slate-500"
          variants={children}
        >
          <Link href="/">
