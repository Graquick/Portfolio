        ...
        {/* ModalS */}
          ...
          >
              ...
              >
                ...
                <motion.div className="row-span-3 overflow-hidden bg-blue-500 rounded-md z-5 xl:order-3 xl:row-start-2 xl:col-start lg:h-[515px] lg:order-3 lg:row-start-3 col-start-1" variants={gridVariants}
                >
