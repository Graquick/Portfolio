...
setShowFalse: () => setShowCModal(false), modalType: <ApparellModal /> },
  ...
  return (
    <div className="px-5 py-0 transition duration-500 bg-gray-200 dark:bg-neutral-800" >
      ...
      <footer className="max-w-[1400px] w-[90%] m-auto bg-white/90 backdrop-blur-sm shadow-sm flex py-6 px-0 justify-center text-md uppercase dark:bg-neutral-00 dark:text-gray-300"
       // className="footer"
      >
