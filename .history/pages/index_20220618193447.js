        ...
        >
            ...
            >
              ...
              >
                ...
                <motion.div className="w-[fit-content] bg-red-500 text-4xl uppercase relative group-hover:w-full"
                      ...
                      >
                        ...
                        <div className="absolute bottom-0 left-0 w-[0%] h-[2px] bg-fuchsia-500 flex justify-end items-end font-extrabold transition-all duration-150 ease-in-out"></div>
                </motion.div>
                {/* {currentTheme === "dark" ?
                    (
