...
const modalContent = [
  { id: 1, setShowTrue: () => setShowModal(true), title: <div className={styles.snap}>snap</div>, setShowFalse: () => setShowModal(false), modalType: <HtmlModal /> },
  { id: 2, setShowTrue: () => setShowCModal(true), title: <div className={styles.snap}>snap</div>, setShowFalse: () => setShowCModal(false), modalType: <CssModal /> },
  { id: 3, setShowTrue: () => setShowJModal(true), title: <div className={styles.snap}>snap</div>, setShowFalse: () => setShowJModal(false), modalType: <JavaModal /> },
  { id: 4, setShowTrue: () => setShowRModal(true), title: 'Calculator', setShowFalse: () => setShowRModal(false), modalType: <ReactModal /> },
  { id: 5, setShowTrue: () => setShowNModal(true), title: 'Todo App', setShowFalse: () => setShowNModal(false), modalType: <NextModal /> },
]
