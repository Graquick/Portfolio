...
const modalContent = [
  { id: 1, setShowTrue: () => setShowModal(true), title: 'boots', setShowFalse: () => setShowModal(false), modalType: <HtmlModal /> },
  { id: 2, setShowTrue: () => setShowCModal(true), title: 'banana', setShowFalse: () => setShowCModal(false), modalType: <CssModal /> },
  { id: 3, setShowTrue: () => setShowJModal(true), title: 'me', setShowFalse: () => setShowJModal(false), modalType: <JavaModal /> },
