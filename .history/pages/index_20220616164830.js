...
>
  ...
  { id: 3, setShowTrue: () => setShowJModal(true), title: <div className={styles.bfBlog}><div style={{ width: 131, height: 64 }}>
  <p
  >
    my
  </p>
...
</div></div>, setShowFalse: () => setShowJModal(false), modalType: <JavaModal /> },
