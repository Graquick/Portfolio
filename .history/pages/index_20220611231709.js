...
const modalContent = [
  { id: 1, setShowTrue: () => setShowBLM(true), src: 'sneakers', setShowFalse: () => setShowBLM(false), modalType: <BootsLM showBLM={showBLM} , modalName: BootsLM, func: `showBLM=${showBLM}`, setfunc: `setShowBLM=${setShowBLM}` }
]
