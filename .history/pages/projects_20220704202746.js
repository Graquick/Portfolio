                        ...
                        return (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <motion.div className="text-[1.5rem] uppercase h-[45px] w-[fit-content] p-2 relative bottom-0 left-0 flex items-center justify-center border-2 border-black bg-green-400 text-white rounded  dark:text-black dark:bg-gray-200 xl:bottom-1"
                                        variants={gridVariants}
