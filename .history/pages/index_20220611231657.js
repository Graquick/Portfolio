...
const modalContent = [
  { id: 1, setShowTrue: () => setShowBLM(true), src: 'sneakers', setShowFalse: () => setShowBLM(false), modalType: <BootsLM  , modalName: BootsLM, func: `showBLM=${showBLM}`, setfunc: `setShowBLM=${setShowBLM}` }
]
