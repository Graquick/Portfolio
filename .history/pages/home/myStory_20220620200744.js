      ...
      {/* ModalS */}
        ...
        >
            ...
            >
              ...
              <motion.div className="flex flex-col col-span-1 row-span-1 p-8 mb-8 text-left shadow-md bg-white/80 backdrop-blur-sm dark:bg-black/50"
              ...
              <motion.div className="flex flex-col col-span-1 p-8 mb-8 text-left shadow-md bg-white/80 backdrop-blur-sm dark:bg-black/50"
                // className={styles.helloCard}
                variants={gridVariants}>
