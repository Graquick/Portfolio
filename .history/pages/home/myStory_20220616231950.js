        ...
        >
            ...
            >
              <motion.div className={styles.helloCard} variants={gridVariants}>
                <h1>About</h1>
                <p>I am a Frontend Developer based in Finland. I have focused the last 2 years on HTML, CSS, and Javascript. My main platform has been React, powered with Next.js.</p>
              </motion.div>
              
              <motion.div className={styles.helloCard} variants={gridVariants}>
                <p>I am also a UI/UX Designer. I have been designing for more than 5 years. My most used platforms in design are Figma, Canva, and Adobe XD.</p>
                <br />
                <p>I am looking for growth opportunities and new challenges, as I am very  </p>
