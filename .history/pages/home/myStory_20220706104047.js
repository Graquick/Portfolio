        ...
        {/* ModalS */}
          ...
          >
              ...
              >
                ...
                <div className="items-center justify-center  w-full h-[18%] 2xl:h-[13%] xl:h-[16%]"
                  // INTRO
                >
                ...
                <div className="h-[20%] 2xl:h-[24%] xl:h-[23%] lg:h-[18%]"
                  // FRONTEND WORK
                >
                ...
                <div className="h-[30%] 2xl:h-[24%] xl:h-[23%] lg:h-[18%]"
                  // EXTRAS
                >
                  <div className="h-[8.5%] w-fit text-[1.2rem] font-semibold text-gray-400 uppercase dark:text-gray-500 xl:text-[1rem] lg:text-[.8rem]"
                    // className={styles.subDiv}
                  ...
                  <motion.div className="w-full overflow-hidden shadow-md bg-white/80 backdrop-blur-sm cursor-grab h-4/5 relative before:content-['scrollable_\1f91a'] before:absolute before:bottom-0 before:left-0 before:font-medium before:text-[1.125rem] before:w-[140px] before:h-[30px] before:py-0 before:px-2 before:text-gray-400 before:cursor-default dark:bg-neutral-700 dark:text-gray-200 2xl:h-[65%] lg:h-[90%]"
                    // className={styles.modalCard}
                  variants={gridVariants}
                    initial="hidden"
                    animate="visible"        
