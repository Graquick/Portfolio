...
const carousel = useRef();
  ...
  const designModalContent = [
    { id: 1, setShowTrue: () => setShowTannerModal(true), title: <div className="w-64 h-64 border-4 border-black bg-no-repeat bg-cover cursor-pointer bg-[url('/tanner-hero.PNG')]"></div>, setShowFalse: () => setShowRModal(false), modalType: <TannerModal /> },
  ]
