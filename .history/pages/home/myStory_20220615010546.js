  ...
  return (
    <div className="px-5 py-0">
      ...
      <Header variants={pageNotLoad} />
        ...
        <motion.main className={styles.main} id="myStory" 
        >
            ...
            >
              ...
              <motion.div className={styles.helloCard} variants={gridVariants}>
                ...
                <Link href="#myStoryCont">
                  <motion.div style={{ textAlign: "right", width: 50, height: 50, cursor: "pointer"}}
            ...
            >
              ...
              <motion.div className={styles.helloCard} variants={gridVariants}>
                ...
                <Link href="#myStory">
                  <motion.div style={{ justifySelf: "right", width: 50, height: 50, cursor: "pointer"}}
                    whileHover={{ y: 10, transition: { duration: .1 }}}
                    whileTap={{ scale: 0.9 }}
                  >
                      <a>&darr;</a>
