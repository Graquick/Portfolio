        ...
        {/* ModalS */}
          ...
          >
              ...
              >
                ...
                <div className="items-center justify-center bg-orange-700 w-full h-full col-span-2 lg:col-span-1"
                  // INTRO
                >
                  <motion.div className="flex w-full flex-col bg-blue-300 items-center justify-center h-full p-8 mb-8 backdrop-blur-sm lg:w-full bg-white/80 shadow"
                    // className={styles.helloCard}
                  variants={gridVariants}>
                    <p className=" flex flex-col items-center justify-center text-[2.25rem] mb-8 leading-relaxed text-justify 2xl:text-[1.55rem] xl:text-[1.55rem] lg:text-[1rem]">I&apos;m Brima Freeman, a Frontend Developer and a UI/UX Designer based in Finland. I specialize in designing and developing websites and mobile applications. More specifically, I work with React and Next.js to build my projects. </p>
                    <br />
                  </motion.div>
                </div>
