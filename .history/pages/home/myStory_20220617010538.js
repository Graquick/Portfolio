...
import galleryItem1 from '../../components/Modals/galleryItem1';
...
const carousel = useRef();
 ...
 const modalContent = [
  { id: 1, setShowTrue: () => setShowG1Modal(true), title: <div className={styles.gallery1}>Gallery Item 1</div>, setShowFalse: () => setShowG1Modal(false), modalType: <gallerItem1 /> },
]
