        ...
        {/* ModalS */}
          ...
          >
              ...
              >
                ...
                <div className="flex flex-col items-center justify-center bg-orange-700 w-full h-full col-span-2 lg:col-span-1"
                  // INTRO
                >
                  <motion.div className="flex w-full flex-col items-center justify-center h-full p-8 mb-8 backdrop-blur-sm lg:w-full bg-white/80 shadow"
