          ...
          >
              ...
              >
                ...
                <div className="flex justify-around w-full h-full col-span-2 lg:col-span-1"
                  // INTRO
                >
                  <motion.div className="flex w-[45%] flex-col p-8 mb-8 text-left shadow-md bg-white/80 backdrop-blur-sm dark:bg-black/50 lg:w-full"
                    // className={styles.helloCard}
                  variants={gridVariants}>
                    <h1 className="font-medium text-[5rem] mb-4 xl:text-[4rem]">Work</h1>
                    <p className="text-[1.7rem] mb-8 leading-relaxed text-justify 2xl:text-[1.55rem] xl:text-[1.55rem] lg:text-[1rem]">I am a <span className="inline-block px-4 py-0 text-white bg-neutral-400 transition-all duration-150 ease-in-out">Frontend Developer</span> based in Finland. I have a 2 year experience in React.</p>
                  </motion.div>
