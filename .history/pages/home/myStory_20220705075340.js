          ...
          >
              ...
              >
                ...
                <div className="flex justify-around w-full h-full col-span-2 lg:col-span-1"
                  // INTRO
                >
                  <motion.div className="flex w-full flex-col p-8 mb-8 backdrop-blur-sm lg:w-full"
                    // className={styles.helloCard}
                  variants={gridVariants}>
                    <p className="text-[2.25rem] mb-8 leading-relaxed font-medium text-justify 2xl:text-[1.55rem] xl:text-[1.55rem] lg:text-[1rem]">I&apos;m Brima Freeman, a Frontend Developer based in Finland. I specialise in designing and developing websites and mobile applications. More specifically, I work with React and Next.js to build my projects. </p>
                    <br />
                    <pclassName="text-[2.25rem] mb-8 leading-relaxed font-medium text-justify 2xl:text-[1.55rem] xl:text-[1.55rem] lg:text-[1rem]">I&apos;m Brima Freeman, a Frontend Developer based in Finland. I specialise in designing and developing websites and mobile applications. More specifically, I work with React and Next.js to build my projects. </pclassName=>
                  </motion.div>
                </div>
