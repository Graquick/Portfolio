            ...
            >
              ...
              >
                ...
                <motion.div className="flex w-[45%] flex-col p-8 mb-8 text-left shadow-md bg-white/80 backdrop-blur-sm dark:bg-black/50"
                  ...
                  <br />
                  <p className="text-[1.65rem] mb-8 leading-relaxed text-justify ">I am looking for growth opportunities and new challenges, as I am very interested in improving myself.  </p>
                </motion.div>
              </div>
