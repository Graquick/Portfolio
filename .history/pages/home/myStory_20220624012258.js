...
const carousel = useRef();
  ...
  const extraModalContent = [
    {id: 1, title: <div className=" w-fit h-32 text-[4rem] text-gray-200 dark:text-gray-600 cursor-default uppercase">Coming soon</div>},
    {id: 2, title: <div className=" w-fit h-32 text-[4rem] text-gray-200 dark:text-gray-600 cursor-default uppercase">Coming soon</div>},
    {id: 3, title: <div className=" w-fit h-32 text-[4rem] text-gray-200 dark:text-gray-600 cursor-default uppercase">Coming soon</div>},
  ]
      ...
      {/* ModalS */}
        ...
        >
            ...
            >
              ...
              <div className="bg-red-300 h-fit flex items-center justify-center w-full col-span-2 row-span-1">
                <motion.div className="mt-8 w-fit h-[50px] text-[1.25rem] uppercase flex bg-blue-200 justify-around items-center relative cursor-pointer text-white dark:text-white group hover:text-black before:content[''] before:absolute before:bottom-0 before:left-0 before:bg-black before:w-full before:h-full before:z-[-1] before:transition-all before:duration-200 before:ease-in-out hover:before:h-[5px]"
                    whileTap={{ scale: 0.9 }}
                >
                    &larr;<Link href="/"><a className="group-hover:text-black ml-8">Head back home.</a></Link>
                </motion.div>
              </div>
