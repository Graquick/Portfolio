...
const carousel = useRef();
  ...
  const designModalContent = [
    { id: 1, setShowTrue: () => setShowTannerModal(true), title: <div className="w-40 h-40  bg-black/50 cursor-pointer"></div>, setShowFalse: () => setShowRModal(false), modalType: <TannerModal /> },
  ]
