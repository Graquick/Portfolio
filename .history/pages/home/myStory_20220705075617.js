          ...
          >
              ...
              >
                ...
                <div className="flex justify-around w-full h-full col-span-2 lg:col-span-1"
                  // INTRO
                >
                  <motion.div className="flex w-full flex-col p-8 mb-8 backdrop-blur-sm lg:w-full bg-white/80 shadow-md"
                  ...
                  variants={gridVariants}>
                    ...
                    <br />
                    <p className="text-[2.25rem] mb-8 leading-relaxed font-medium text-justify 2xl:text-[1.55rem] xl:text-[1.55rem] lg:text-[1rem]">I&apos;m also a UI/UX Designer. My design work focuses around websites and </p>
                  </motion.div>
                </div>
