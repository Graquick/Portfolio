        ...
        >
            ...
            >
              <motion.div className={styles.helloCard} variants={gridVariants}>
                <h1>About</h1>
                <p>I&apos;m a Frontend Developer based in Finland. I have focused the last 2 years on HTML, CSS, and Javascript. My main platform is React, powered with the production </p>
                <br />
