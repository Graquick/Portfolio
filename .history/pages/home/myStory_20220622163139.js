...
import CalcModal from "../../components/Modals/TannerModal";
...
const carousel = useRef();
  ...
  const designModalContent = [
    { id: 1, setShowTrue: () => setShowTannerModal(true), title: <div className="font-play text-[2.5rem] font-[600] relative text-gray-200 cursor-pointer capitalize transition-[color] duration-color-500 transition-[transform] duration-transform-150 ease-in-out hover:text-black dark:text-zinc-600 dark:hover:text-zinc-300">Calco,inc.</div>, setShowFalse: () => setShowRModal(false), modalType: <TannerModal /> },
  ]
