      ...
      {/* ModalS */}
        ...
        >
            ...
            >
              ...
              <div>
                <motion.div className="mt-8 w-fit h-[50px] text-[1.25rem] uppercase flex justify-around items-center relative cursor-pointer text-white dark:text-white group hover:text-black before:content-[''] before:absolute before:bottom-0 before:left-0 before:bg-black before:w-full before:h-full z-10 before:transition-all before:duration-200 before:ease-in-out hover:before:h-[5px]"
                    whileTap={{ scale: 0.9 }}
                >
