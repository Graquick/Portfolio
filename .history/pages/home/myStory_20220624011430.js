      ...
      {/* ModalS */}
        ...
        >
            ...
            >
              ...
              <div>
                <motion.div className="mt-8 w-[200px] h-[50px] text-[1.25rem] uppercase flex justify-around items-center relative cursor-pointer text-white darl:text-black group hover:text-black before:content-[''] before:absolute before:bottom-0 before:left-0 before:bg-black before:w-full before:h-full before:z-[-1] before:transition-all before:duration-200 before:eas"
