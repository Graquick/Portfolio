      ...
      {/* <Header variants={pageNotLoad} /> */}
        ...
        >
            ...
            >
              ...
              <motion.div className={styles.helloCard} variants={gridVariants}>
                <p>I started at <motion.div whileHover={{ y: 10, color: "#000", transition: { duration: .1 } }} whileTap={{ scale: .9 }}><Link href="https://www.freecodecamp.org/"><a style={{ textTransform: "none", fontWeight: 600, fontSize: "1.25rem", color: "#d7d7d7" }}>freeCodeCamp.org</a></Link></p>
