          ...
          >
              ...
              >
                ...
                >
                  ...
                  variants={gridVariants}>
                    <p className="text-[2.25rem] mb-8 leading-relaxed text-justify 2xl:text-[1.55rem] xl:text-[1.55rem] lg:text-[1rem]">I&apos;m Brima Freeman, a Frontend Developer and an UI/UX Designer based in Finland. I specialise in designing and developing websites and mobile applications. More specifically, I work with React and Next.js to build my projects. </p>
                    <br />
                  </motion.div>
                </div>
