...
const carousel = useRef();
  ...
  const designModalContent = [
    ...
    { id: 3, setShowTrue: () => setShowApparelMyModal(true), title: <div className="w-64 h-64 bg-no-repeat bg-cover transition-all duration-300 ease-in-out cursor-pointer bg-[url('/apparel-my-hero.PNG')]"></div>, setShowFalse: () => setShowApparelMyModal(false), modalType: <ApparelMyModal /> },
  ...
  const extraModalContent = [
    {id: 1, title: <div className=" w-fit h-fit text-[2rem] text-gray-200 dark:text-gray-600 cursor-default uppercase">Coming soon</div>},
    {id: 2, title: <div className=" w-fit h-fit text-[2rem] text-gray-200 dark:text-gray-600 cursor-default uppercase">Coming soon</div>},
    {id: 3, title: <div className=" w-fit h-fit text-[2rem] text-gray-200 dark:text-gray-600 cursor-default uppercase">Coming soon</div>},
  ]

  return (
    <>
      <div className="px-5 transition duration-500 bg-gray-200 pt-40 dark:bg-neutral-800 lg:px-0 lg:pt-[5.5rem]">
        <Head>
        ...
        {/* ModalS */}
          ...
          >
              ...
              >
                ...
                <div className="flex justify-around w-full h-full col-span-2 lg:col-span-1"
                  // INTRO
                >
                  <motion.div className="flex w-[48%] flex-col p-8 mb-8 text-left shadow-md bg-white/80 backdrop-blur-sm dark:bg-black/50 lg:w-full"
                    // className={styles.helloCard}
                  variants={gridVariants}>
                    <h1 className="font-medium text-[5rem] mb-4 xl:text-[4rem]">Work</h1>
                    <p className="text-[1.7rem] mb-8 leading-relaxed text-justify 2xl:text-[1.55rem] xl:text-[1.325rem] lg:text-[1rem]">I am a <span className="inline-block px-4 py-0 text-white bg-neutral-400 transition-all duration-150 ease-in-out">Frontend Developer</span> based in Finland. I have a 2 year experience in React, N</p>
                  </motion.div>
                  
                  <motion.div className="flex w-[48%] flex-col p-8 mb-8 text-left shadow-md bg-white/80 backdrop-blur-sm dark:bg-black/50"
                    // className={styles.helloCard}
                    variants={gridVariants}>
                    <p className="text-[1.7rem] mb-8 leading-relaxed text-justify 2xl:text-[1.5rem] xl:text-[1.25rem] lg:text-[1rem]">I am also a <span className="inline-block px-4 py-0 text-white bg-neutral-400 transition-all duration-150 ease-in-out ">UI/UX Designer</span>. I have been designing for more than 5 years. My most used platforms are Figma, Canva, and Adobe XD.</p>
                    <br />
                    <p className="text-[1.7rem] mb-8 leading-relaxed text-justify 2xl:text-[1.5rem] xl:text-[1.1rem] lg:text-[1rem]">I am looking for growth opportunities and new challenges, as I am very interested in improving myself.  </p>
                  </motion.div>
                </div>
                ...
                <div className="flex flex-col w-full h-full col-span-2 row-span-1"
                  // FRONTEND WORK
                >
                  <div className="h-[8.5%] w-fit text-[1.2rem] font-semibold text-gray-400 uppercase dark:text-gray-500"
                ...
                <div className="flex w-[1400px] m-auto mb-4 col-span-2 row-span-1 h-fit 2xl:w-[1000px] xl:w-[750px] lg:w-[355px]">
                  <motion.div className="text-[1.5rem] uppercase h-[60px] w-[fit-content] p-2 relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:bg-black after:w-[0%] after:h-[2px] after:flex after:justify-end after:items-end after:transition-all after:duration-150 after:ease-in-out hover:after:w-full dark:text-gray-200 dark:after:bg-gray-200"
                    ...
                    >
                        <Link href="/">
                            <div className="cursor-pointer">&#8598; Head Back Home</div>
                        </Link>
                  </motion.div>
                </div>
