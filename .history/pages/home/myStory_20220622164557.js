...
const carousel = useRef();
  ...
  const designModalContent = [
    { id: 1, setShowTrue: () => setShowTannerModal(true), title: <div className="w-64 h-64 bg-no- cursor-pointer bg-[url('/tanner-hero.PNG')]"></div>, setShowFalse: () => setShowRModal(false), modalType: <TannerModal /> },
  ]
