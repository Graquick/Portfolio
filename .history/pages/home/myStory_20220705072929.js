...
const carousel = useRef();
  ...
  return (
    <>
      <div className="px-5 transition duration-500 bg-gray-200 pt-48 dark:bg-neutral-800 lg:px-0 lg:pt-[5.5rem]">
        <Head>
