        ...
        >
            ...
            >
              ...
              <div className="bg-red-300 h-fit flex items-start justify-start w-full col-span-2 row-span-1">
                <motion.div className="w-fit h-[50px] text-[1.25rem] uppercase flex bg-blue-200 justify-around items-center relative cursor-pointer text-white dark:text-white group hover:text-black before:content-[''] before:absolute before:bottom-0 before:left-0 before:bg-black before:w-full before:h-full before:z-[1] z- before:transition-all before:duration-200 before:ease-in-out hover:before:h-[5px]"
                    whileTap={{ scale: 0.9 }}
                >
