...
const carousel = useRef();
  ...
  const designModalContent = [
    ...
    { id: 3, setShowTrue: () => setShowSnapMyModal(true), title: <div className="w-64 h-64 grayscale bg-no-repeat bg-cover hover:grayscale-0 transition-all duration-300 ease-in-out cursor-pointer bg-[url('/snap-my-hero.PNG')]"></div>, setShowFalse: () => setShowSnapMyModal(false), modalType: <ApparelMyModal /> },
