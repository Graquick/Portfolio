              ...
              >
                ...
                >
                  ...
                  <motion.div className="flex w-[48%] flex-col p-8 mb-8 text-left shadow-md bg-white/80 backdrop-blur-sm dark:bg-black/50"
                    // className={styles.helloCard}
                    variants={gridVariants}>
                    <p className="text-[1.7rem] mb-8 leading-relaxed text-justify 2xl:text-[1.5rem] xl:text-[1.3rem] lg:text-[1rem]">I am also a <span className="inline-block px-4 py-0 text-white bg-neutral-400 transition-all duration-150 ease-in-out ">UI/UX Designer</span>. I have been designing for more than 5 years. My most used platforms are Figma, Canva, and Adobe XD.</p>
                    <br />
