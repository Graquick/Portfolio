...
import SnapMyModal from "../../components/Modals/ApparelMyModal";
...
const carousel = useRef();
  ...
  const designModalContent = [
    ...
    { id: 3, setShowTrue: () => setShowApparelMyModal(true), title: <div className="w-64 h-64 grayscale bg-no-repeat bg-cover hover:grayscale-0 transition-all duration-300 ease-in-out cursor-pointer bg-[url('/snap-my-hero.PNG')]"></div>, setShowFalse: () => setShowApparelMyModal(false), modalType: <ApparelMyModal /> },

    { id: 4, setShowTrue: () => setShowSnapMyModal(true), title: <div className="w-64 h-64 grayscale bg-no-repeat bg-cover hover:grayscale-0 transition-all duration-300 ease-in-out cursor-pointer bg-[url('/snap-my-hero.PNG')]"></div>, setShowFalse: () => setShowSnapMyModal(false), modalType: <SnapMyModal /> },
  ]
  ...
  return (
    <div className="px-5 py-0 transition duration-500 bg-gray-200 dark:bg-neutral-800">
      ...
      <SnapMyModal showSnapMyModal={showSnapMyModal} setShowSnapMyModal={setShowApparelMyModal} />
      {/* ModalS */}
