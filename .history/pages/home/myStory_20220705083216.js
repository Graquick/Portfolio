...
const carousel = useRef();
  ...
  const designModalContent = [
    { id: 1, setShowTrue: () => setShowTannerModal(true), title: <div className="w-64 h-64 bg-no-repeat bg-cover transition-all duration-300 ease-in-out cursor-pointer bg-[url('/tanner-hero.PNG')] 2xl:w-36 2xl:h-40"></div>, setShowFalse: () => setShowTannerModal(false), modalType: <TannerModal /> },

    { id: 2, setShowTrue: () => setShowSnapMyModal(true), title: <div className="w-64 h-64 bg-no-repeat bg-cover transition-all duration-300 ease-in-out cursor-pointer bg-[url('/snap-my-hero.PNG')] 2xl:w-36 2xl:h-40"></div>, setShowFalse: () => setShowSnapMyModal(false), modalType: <SnapMyModal /> },

    { id: 3, setShowTrue: () => setShowApparelMyModal(true), title: <div className="w-64 h-64 bg-no-repeat bg-cover transition-all duration-300 ease-in-out cursor-pointer bg-[url('/apparel-my-hero.PNG')] 2xl:w-36 2xl:h-40"></div>, setShowFalse: () => setShowApparelMyModal(false), modalType: <ApparelMyModal /> },

    { id: 4, setShowTrue: () => setShowSteppModal(true), title: <div className="w-64 h-64 bg-no-repeat bg-cover transition-all duration-300 ease-in-out cursor-pointer bg-[url('/stepp-hero.PNG')] 2xl:w-36 2xl:h-40"></div>, setShowFalse: () => setShowSteppModal(false), modalType: <SteppModal /> },
  ]
