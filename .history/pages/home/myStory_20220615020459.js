    ...
    <div className="px-5 py-0">
      ...
      <Header variants={pageNotLoad} />
        ...
        >
            ...
            <motion.div className={styles.grid} id="myStoryEnd" style={{ gridTemplateRows: "45% 45% 30%", height: 1200 }}
              variants={gridVariants}
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, amount: .8 }}
            >
              ...
              <motion.div className={styles.imgCard} variants={gridVariants} style={{ gridColumnStart: span 3 }}>
                <Image src="/sneakers.jpg"
                  width={140} height={210} layout="responsive"
                  objectFit={"cover"}
                  blurDataURL="/sneakers.jpg"
