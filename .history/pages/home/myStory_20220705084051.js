          ...
          >
              ...
              >
                ...
                <div className="flex w-[fit-content] m-auto mb-4 col-span-2 row-span-1 h-fit 2xl:w-[1000px] xl:w-[750px] lg:w-[355px] cursor-pointer">
                  <Link href="/">
                    <motion.div className="text-[1.5rem] uppercase h-[60px] w-[fit-content] p-2 relative flex items-center justify-center gap-4 bg-neutral- dark:text-gray-200 dark:after:bg-gray-200"
