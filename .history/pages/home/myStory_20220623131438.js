...
const carousel = useRef();
  ...
  const designModalContent = [
    ...
    { id: 2, setShowTrue: () => setShowSnapMyModal(true), title: <div className="w-64 h-64 grayscale bg-no-repeat bg-cover hover:grayscale-0 transition-all duration-300 ease-in-out cursor-pointer bg-[url('/tanner-hero.PNG')]"></div>, setShowFalse: () => setShowRModal(false), modalType: <SnapMyModal /> },
  ]
