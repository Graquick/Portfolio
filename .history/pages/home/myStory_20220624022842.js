...
const carousel = useRef();
  ...
  const designModalContent = [
    ...
    { id: 4, setShowTrue: () => setShowSteppModal(true), title: <div className="w-64 h-64 bg-no-repeat bg-cover transition-all duration-300 ease-in-out cursor-pointer bg-[url('/static/stepp-hero.PNG')]"></div>, setShowFalse: () => setShowSteppModal(false), modalType: <SteppModal /> },
  ]
