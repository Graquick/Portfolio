...
const carousel = useRef();
  ...
  const frontEndModalContent = [
    ...
    className="absolute top-[2.5rem] -right-8 w-[26px] h-[26px] transition-all duration-500 ease-in-out group-hover:fill-black group-hover:stroke-black lg:text-[3rem]"
    width={26}
    height={24}
    viewBox="0 0 26 24"
    fill="none"
