          ...
          >
              ...
              >
                ...
                <div className="flex flex-col w-full h-full col-span-2 row-span-1"
                  // DESIGN WORK
                >
                  <div className="h-[8.55%] w-fit text-[1.2rem] font-semibold text-gray-400 uppercase dark:text-gray-500  xl:text-[1rem] lg:text-[.8rem]"
                    // className={styles.subDiv}
                  >
                    design work
                  </div>
                ...
                <div className="flex flex-col w-full h-full col-span-2 row-span-1"
                  // EXTRAS
                >
                  <div className="h-[5%] w-fit text-[1.2rem] font-semibold text-gray-400 uppercase dark:text-gray-500 xl:text-[1rem] lg:text-[.8rem]"
                    // className={styles.subDiv}
                  >
                    extras
                  </div>
