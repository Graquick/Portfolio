...
export default function Home() {
  ...
  const mainContent = [
    { id: 1, title: 'NEXT UP', desc: 'Welcome to my website! I have been looking forward to meeting you. Click the link below to start.', href: '/part-one', href2: 'back to the start', src: 'boots'}
]
