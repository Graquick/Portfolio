      ...
      {/* ModalS */}
        ...
        >
            ...
            >
              ...
              <div className="flex justify-between w-full h-full col-span-3 bg-green-500"
                // INTRO
              >
                <motion.div className="flex w-[58%] flex-col p-8 mb-8 text-left shadow-md bg-white/80 backdrop-blur-sm dark:bg-black/50"
