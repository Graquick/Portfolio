        ...
        >
            ...
            >
              <motion.div className={styles.helloCard} variants={gridVariants}>
                <h1>About</h1>
                <p>I am a <span>Frontend Developer</span> based in Finland. I have focused the last 2 years on HTML, CSS, and Javascript. My main platform has been <span>React</span>, powered with <span>Next.js</span>.</p>
              </motion.div>
              
              <motion.div className={styles.helloCard} variants={gridVariants}>
                <p>I am also a <span>UI/UX Designer</span>. I have been designing for more than 5 years. My most used platforms in design are <span>Figma</span>, <span>Canva</span>, and <span>Adobe XD</span>.</p>
                <br />
