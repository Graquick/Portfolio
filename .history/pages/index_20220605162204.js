...
export default function Home() {
  ...
  return (
    <div className="bg-red-300 px-5 py-0">
      ...
      <motion.main className="bg-gray-500 min-h-screen flex flex-col gap-8 px-0 py-16 align-center"
        variants={container}
        initial="hidden"
        animate="visible"
        exit="exit"
      ...
      >
        ...
        <motion.div className="flex bg-sky-700 h-3/4 flex-wrap justify-center mx-auto my-0 max-w-7xl align-center"
