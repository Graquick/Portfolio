        ...
        <div className="px-5 transition duration-500 bg-gray-200 pt-36 dark:bg-neutral-800 lg:px-0 lg:pt-[6rem]">
            ...
            >
                ...
                <motion.div className={styles.grid} variants={gridVariants}>
                    ...
                    <form className="px-8 pt-8 text-left no-underline shadow-md text-inherit bg-white/80 backdrop-blur-sm dark:bg-black/50 2xl:py-4 2xl:px-4 lg:p-0 "
                    ...
                    >
                        ...
                        <div className={styles.formContent}>
                            ...
                            <div className="flex flex-col items-center justify-center h-[375px] bg-red-400 lg:h-fit">
