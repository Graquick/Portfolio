        ...
        <div className="px-5 transition duration-500 bg-gray-200 pt-28 dark:bg-neutral-800 lg:px-0">
            ...
            >
                ...
                <motion.div className={styles.grid} variants={gridVariants}>
                    <div className="flex flex-col justify-around px-12 py-4 text-left no-underline shadow-md bg-white/80 backdrop-blur-sm dark:bg-black/50 2xl:px-4 2xl:items-center xl:p-8">
