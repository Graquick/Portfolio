...
const modalContent = [
  { id: 1, setShowBLMTrue: () => setShowBLM(true), src: 'sneakers', setShowBLMFalse: () => setShowBLM(false), modalName: SneakersLM, func: showBLM, setfunc: setShowBLM },
  { id: 2, setShowBLMTrue: () => setShowBLM(true), src: 'boots', setShowBLMFalse: () => setShowBLM(false), modalName: SneakersLM, func: showBLM, setfunc: setShowBLM }
]
                    ...
                    {modalContent.map((modal) => {
                      return (
                        ...
                        >
                            ...
                            placeholder="blur"
                            />
                          <AnimatePresence exitBeforeEnter onExitComplete={modal.setShowBLMFalse}>
                            <modal.modalName showModal={modal.func} setShowModal={modal.setfunc}/>
                          </AnimatePresence>
                        </motion.div>
                      )
                    })}
