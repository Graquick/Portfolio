  ...
  return (
    <div className="bg-red-300 px-5 py-0">
      ...
      >
        ...
        <motion.div className="flex bg-sky-700 flex-wrap font-Raleway justify-center w-3/4 h-3/5 align-center"
          // className={styles.grid}
        >
            <Link href="/">
              <motion.a className=" p-4 text-left no-underline border border-gray-200 border-solid cursor-pointer h-64 rounded-xl w-72"
              ...
              >
                ...
                <p className="m-0 text-2xl">Explore my latest work including Frontend and Backend development.</p>
              </motion.a>
            </Link>
        </motion.div>
