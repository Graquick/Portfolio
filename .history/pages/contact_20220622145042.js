                        ...
                        <div className={styles.formContent}>
                            <div className={styles.formNameContent}>
                                <div className={styles.formInputTheme}>
                                    ...
                                    <input name="fullname" type="text" id="fullname" placeholder="Name" required className="p-2 text-[1.125rem] tracking-widest shadow-sm h-[40px] placeholder:text-gray-200 focus:outline-none focus:border-gray-300"
