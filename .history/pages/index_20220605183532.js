...
const links = [
  { id: 1, icon: 'bx-moon', href: '/' },
  { id: 2, icon: 'bx-moon', href: '/gallery' },
  { id: 3, icon: 'bx-moon', href: '/contact' }
]
                    ...
                    return (
                        ...
                        >
                            <motion.div className={styles.gridInfo}>
                              ...
                              <div className={stylesli.}>
                                <ul className={styles.links}
                                >
                                  {links.map((links, i) => (
                                    <motion.div className={styles.liIcon}
                                      key={links.id}
                                      initial={{ opacity: 0, y: -100 }}
                                      initial={{ opacity: 1, y: 0, transition: {duration: 0.2, delay: i * 0.25}}}
                                      >
