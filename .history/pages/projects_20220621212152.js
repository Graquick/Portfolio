    ...
    const container = {
      ...
      >
        ...
        <rect
          ...
          strokeWidth="2.4"
        />
        <circle cx={13} cy={7} r="2.5" className="stroke-white fill-black group-hover:fill-black group-hover:stroke-white dark:stroke-black/50 dark:fill-black/50 dark:group-hover:fill-zinc-300 dark:group-hover:stroke-black/50"/>
