...
setShowFalse: () => setShowCModal(false), modalType: <ApparellModal /> },
  ...
  { id: 4, setShowTrue: () => setShowRModal(true), title: <div className="font-play text-[2.5rem] font-[600] relative text-gray-200 cursor-pointer capitalize transition-[color] duration-500 ease-in-out hover:text-black">Calco,inc.</div>, setShowFalse: () => setShowRModal(false), modalType: <CalcModal /> },
]
