  ...
  const currentTheme = theme === "system" ? systemTheme : theme;
    ...
    const container = {
      ...
      >
        ...
        { id: 2, title: <div className="font-roboto text-[4rem] font-light text-black cursor-default transition-all duration-150 ease-in-out relative group xl:text-[2.5rem] lg:mt-2 dark:text-white">.apparell</div>, desc: <p>This Ecommerce website has a lightbox product gallery and cart functionality! When building I got to use a lot of different libraries to build this!<div className="flex flex-wrap w-full gap-[.6rem] mt-8 h-fit xl:gap-2 xl:mt-[1.6rem]"><span className="py-2 px-3 text-black shadow-md rounded-md font-bold cursor-default text-[1.1rem] w-fit flex items-center justify-center gap-2 xl:text-[.9rem] xl:py-1 bg-white dark:shadow-neutral-700 ">Figma <Icon icon="logos:figma" className="text-[1.2rem] xl:text-[.9rem]"/></span><span className="py-2 px-3 text-black shadow-md rounded-md cursor-default w-fit flex items-center justify-center gap-1 text-[2rem] xl:text-[1.45rem] xl:py-1 bg-white dark:shadow-neutral-700 "><Icon icon="logos:nextjs" /></span><span className="py-2 px-3 text-black shadow-md rounded-md font-medium cursor-default text-[1.2rem] w-fit flex items-center justify-center gap-1 xl:text-[.9rem] xl:py-1 bg-white dark:shadow-neutral-700 ">React<Icon icon="akar-icons:react-fill" className="text-blue-400"/></span><span className="py-2 px-3 text-black shadow-md rounded-md cursor-default w-fit flex items-center justify-center gap-1 text-[1.1rem] font-medium font-roboto xl:text-[.9rem] xl:py-1 bg-white dark:shadow-neutral-700 "><Icon icon="bxl:tailwind-css" className="text-blue-400" />tailwindcss</span><span className="py-2 px-3 text-black shadow-md rounded-md cursor-default text-[1.2rem] w-fit flex items-center justify-center gap-1 xl:text-[.9rem] xl:py-1 bg-white dark:shadow-neutral-700 "><Icon icon="logos:headlessui" /></span><span className="py-2 px-3 text-black shadow-md rounded-md cursor-default w-fit flex items-center justify-center gap-1 text-[1.2rem] font-extrabold tracking-tighter xl:text-[.9rem] xl:py-1 bg-white dark:shadow-neutral-700 ">Framer Motion<Icon icon="logos:framer"/></span></div></p>, src: 'apparel-projects-hero', srcdark: 'apparel-projects-hero-dark', href: '/', hrefp: 'live site'},
