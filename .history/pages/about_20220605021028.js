...
<div className="px-5 py-0 ">
      ...
      <motion.main className="min-h-screen gap-64 bg-red-700 m-auto max-w-6xl flex flex-col justify-center flex-1 px-0 py-16 align-center"
        variants={container}
        initial="hidden"
        animate="visible"
        exit="exit"
                        ...
                        >
                            ...
                            >
                                <motion.div 
                                    variants={gridVariants}
                                >
                                    <h1 className="text-5xl leading-tight mb-8 font-medium capitalize">{tags.title}</h1>
                                    <p>{tags.desc}</p>
                                </motion.div>
