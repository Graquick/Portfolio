...
setShowFalse: () => setShowCModal(false), modalType: <ApparellModal /> },
  ...
  { id: 4, setShowTrue: () => setShowRModal(true), title: <div className="font-play text-[2.5rem] font-[600] relative text-gray-200 cursor-pointer capitalize transition-[color 500ms ease, transform 150ms ease] hover:">Calco,inc.</div>, setShowFalse: () => setShowRModal(false), modalType: <CalcModal /> },
]
