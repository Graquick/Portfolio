...
setShowFalse: () => setShowCModal(false), modalType: <ApparellModal /> },
  ...
  { id: 3, setShowTrue: () => setShowJModal(true), title: <div className={styles.bfBlog}><div className="text-[1.5rem] font-bold uppercase bg-gra">bf</div><div className={styles.bfBlogLogo2}>blog</div></div>, setShowFalse: () => setShowJModal(false), modalType: <BfBlogModal /> },
