...
const About = () => {
  ...
  const currentTheme = theme === "system" ? systemTheme : theme;
    ...
    const container = {
      ...
      </svg>snap</div>, desc: 'This challenge tested my ability to create dropdown navigation menus, a common pattern on larger sites. It also provided some nice basic layout challenges. All the design was done by Figma. I developed the final product using Next.js and Vercel.', src: 'snap-projects-mobile-hero', srcdark: 'snap-projects-mobile-hero-dark', href: '/'},

        { id: 2, title: <div className="font-roboto text-[4rem] font-light text-black cursor-default transition-all duration-150 ease-in-out relative group dark:text-white">.apparell</div>, desc: <p>In this challenge, youll build a beautiful product page. Well be putting your JS skills to the test with a lightbox product gallery and cart functionality!</p>, src: 'apparel-projects-hero', srcdark: 'apparel-projects-hero-dark', href: '/'},
