...
setShowFalse: () => setShowCModal(false), modalType: <ApparellModal /> },
  ...
  { id: 3, setShowTrue: () => setShowJModal(true), title: <div className={styles.bfBlog}><div className={styles.bfBlogLogo}>bf</div><div className={styles.bfBlogLogo2}><div>my</div><div></div></div></div>, setShowFalse: () => setShowJModal(false), modalType: <BfBlogModal /> },
