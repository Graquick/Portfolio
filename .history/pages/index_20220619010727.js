      ...
      {/* ModalS */}
        ...
        >
            ...
            >
              ...
              <motion.div className="flex flex-col p-8 mb-8 text-left shadow-md bg-white/80 backdrop-blur-sm dark:bg-gray-800" 
                // className={styles.helloCard}
                variants={gridVariants}
                initial="hidden"
                animate="visible"
              >
                <h1 className="font-medium text-[5rem] mb-4 dark:text-gray-300">Web Developer</h1>
