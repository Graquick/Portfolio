            ...
            >
                ...
                <motion.div className={styles.grid} variants={gridVariants}>
                    ...
                    >
                        ...
                        <motion.div className="bg-cursor-pointer w-[13rem] h-[3rem] text-[1.25rem] p-3 relative flex items-center justify-center  2xl:p-0 2xl:text-[1.3rem] 2xl:after:-bottom-2 xl:text-[1.2rem] xl:after:h-[1.5px] lg:text-[1rem] lg:h-[2rem] lg:w-[10rem]"
