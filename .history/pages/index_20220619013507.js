...
const modalContent = [
  { id: 1, setShowTrue: () => setShowModal(true), title: <div className="font-[Arial, Helvetica, sans-serif] text-[4rem] font-bold text-gray-200 cursor-auto transition-all duration-150 ease-in-out">  <svg
  width={26}
  height={24}
  viewBox="0 0 26 24"
  fill="none"
