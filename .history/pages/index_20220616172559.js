...
>
  ...
  { id: 3, setShowTrue: () => setShowJModal(true), title: <div className={styles.bfBlog}><div className={styles.bfBlogLogo}>bf</div><div className={styles.bf}>my blog</div></div>, setShowFalse: () => setShowJModal(false), modalType: <JavaModal /> },
