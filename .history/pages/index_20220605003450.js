...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <main className="min-h-screen flex flex-col justify-center flex-1 px-0 py-16 align-center"
      // className={styles.main}
      >
        <motion.h1 className="m-0 text-6xl leading-tight text-center font-semibold uppercase"
