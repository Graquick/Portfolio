...
const modalContent = [
  ...
  { id: 2, setShowTrue: () => setShowCModal(true), title: <div className={styles.markCity}>markcity <Icon icon="uil:" /> </div>, setShowFalse: () => setShowCModal(false), modalType: <CssModal /> },
