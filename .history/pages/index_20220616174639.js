...
>
  ...
  { id: 2, setShowTrue: () => setShowCModal(true), title: <div className={styles.markCity}>apparell
  <svg
  width={63}
  height={72}
  viewBox="0 0 63 72"
...
</div>, setShowFalse: () => setShowCModal(false), modalType: <CssModal /> },
  ...
  { id: 4, setShowTrue: () => setShowRModal(true), title: <div className={styles.snap}>calculatoor!</div>, setShowFalse: () => setShowRModal(false), modalType: <ReactModal /> },
]
