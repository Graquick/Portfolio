...
import snapModal from '../components/Modals/HtmlModal';
import apparellModal from '../components/Modals/CssModal';
import bfBlogModal from '../components/Modals/JavaModal';
import calcModal from "../components/Modals/ReactModal";
...
setShowFalse: () => setShowCModal(false), modalType: <CssModal /> },
  ...
  { id: 3, setShowTrue: () => setShowJModal(true), title: <div className={styles.bfBlog}><div className={styles.bfBlogLogo}>bf</div><div className={styles.bfBlogLogo2}>blog</div></div>, setShowFalse: () => setShowJModal(false), modalType: <JavaModal /> },


  { id: 4, setShowTrue: () => setShowRModal(true), title: <div className={styles.calculator}>Calco,inc.</div>, setShowFalse: () => setShowRModal(false), modalType: <ReactModal /> },
]
