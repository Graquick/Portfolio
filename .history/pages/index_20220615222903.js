...
const modalContent = [
  ...
  { id: 3, setShowTrue: () => setShowRModal(true), src: 'kiwi', setShowFalse: () => setShowRModal(false), modalType: <ReactModal /> },
  { id: 3, setShowTrue: () => setShowNModal(true), src: 'pumpkin', setShowFalse: () => setShowNModal(false), modalType: <NextModal /> },
]
